...
For more on using the Inventory page, refer to <DocLink id="enObservabilityViewInfrastructureMetrics">View infrastructure metrics by resource type</DocLink>.
...
For more on using the **Metrics Explorer** page, refer to <DocLink id="enObservabilityExploreMetrics">Explore infrastructure metrics over time</DocLink>.
...
* <DocLink id="enObservabilityExploreLogs">Logs Explorer</DocLink> for an over view of Logs Explorer.
* <DocLink id="enObservabilityLogsFilterAndAggregate" section="filter-logs-in-log-explorer">Filter logs in Log Explorer</DocLink> for more on filtering logs in Logs Explorer.
