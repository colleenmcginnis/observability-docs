...
Use <DocLink slug="/en/observability/traces-get-started">Get started with application traces and APM</DocLink> to quickly spin up an APM deployment.
Want to host everything yourself instead? See <DocLink slug="/en/observability/apm-getting-started-apm-server">Self manage APM Server</DocLink>.
