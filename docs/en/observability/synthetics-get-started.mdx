---
id: enObservabilitySyntheticsGetStarted
...
Get started in <DocLink id="enObservabilitySyntheticsGetStartedProject">Create monitors with ((project-monitors-cap))</DocLink>.
...
Get started in <DocLink id="enObservabilitySyntheticsGetStartedUi">Create monitors in the ((synthetics-app))</DocLink>.
