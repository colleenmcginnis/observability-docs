---
id: enObservabilityAnalyzeMonitors
slug: /en/observability/analyze-monitors
title: Analyze monitors
description: Description to be written
tags: []
---

<div id="analyze-monitors"></div>
...
<span id="uptime-status-panel"></span>
## Status panel
...
![Uptime status panel](images/uptime-status-panel.png)
...
<span id="uptime-monitor-duration"></span>
## Monitor duration
...
![Monitor duration chart](images/monitor-duration-chart.png)

<span id="uptime-pings-chart"></span>
## Pings over time
...
![Pings over time chart](images/pings-over-time.png)

<div id="uptime-history-panel"></div>
...
![Monitor history list](images/uptime-history.png)