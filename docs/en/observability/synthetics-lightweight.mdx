---
slug: /en/observability/synthetics-lightweight
title: Configure lightweight monitors
description: Description to be written
tags: []
---

import LightweightConfigCommon from './synthetics-reference/lightweight-config/common.mdx'
import LightweightConfigHttp from './synthetics-reference/lightweight-config/http.mdx'
import LightweightConfigIcmp from './synthetics-reference/lightweight-config/icmp.mdx'
import LightweightConfigTcp from './synthetics-reference/lightweight-config/tcp.mdx'
...
Lightweight monitors can be configured using either the <DocLink slug="/en/observability/synthetics-lightweight" section="((synthetics-app))">((synthetics-app))</DocLink>
or <DocLink slug="/en/observability/synthetics-lightweight" section="((project-monitors-cap))">((project-monitors-cap))</DocLink>.
...
For step-by-step instructions, refer to <DocLink slug="/en/observability/synthetics-get-started-ui">Create monitors in the ((synthetics-app))</DocLink>.

![Synthetics Create monitor UI](images/synthetics-get-started-ui-lightweight.png)

<div id="synthetics-lightweight-projects"></div>

## ((project-monitors-cap))

To use YAML files in to create ((project-monitors)), <DocLink slug="/en/observability/synthetics-get-started-project">set up a project</DocLink>
...
For a complete list, refer to <DocLink slug="/en/observability/synthetics-lightweight" section="common-options">Common options</DocLink>.

Each monitor type also has additional configuration options that are specific to that type.
Refer to:

* <DocLink slug="/en/observability/synthetics-lightweight" section="http-options">HTTP options</DocLink>
* <DocLink slug="/en/observability/synthetics-lightweight" section="icmp-options">ICMP options</DocLink>
* <DocLink slug="/en/observability/synthetics-lightweight" section="tcp-options">TCP options</DocLink>
...
Valid options for HTTP monitors include <DocLink slug="/en/observability/synthetics-lightweight" section="common-options">all common options</DocLink>
...
Valid options for ICMP monitors include <DocLink slug="/en/observability/synthetics-lightweight" section="common-options">all common options</DocLink>
...
Valid options for TCP monitors include <DocLink slug="/en/observability/synthetics-lightweight" section="common-options">all common options</DocLink>
