---
id: enObservabilitySyntheticsLightweight
...
Lightweight monitors can be configured using either the <DocLink id="enObservabilitySyntheticsLightweight" section="((synthetics-app))">((synthetics-app))</DocLink>
or <DocLink id="enObservabilitySyntheticsLightweight" section="((project-monitors-cap))">((project-monitors-cap))</DocLink>.
...
For step-by-step instructions, refer to <DocLink id="enObservabilitySyntheticsGetStartedUi">Create monitors in the ((synthetics-app))</DocLink>.
...
To use YAML files in to create ((project-monitors)), <DocLink id="enObservabilitySyntheticsGetStartedProject">set up a project</DocLink>
...
For a complete list, refer to <DocLink id="enObservabilitySyntheticsLightweight" section="common-options">Common options</DocLink>.

Each monitor type also has additional configuration options that are specific to that type.
Refer to:

* <DocLink id="enObservabilitySyntheticsLightweight" section="http-options">HTTP options</DocLink>
* <DocLink id="enObservabilitySyntheticsLightweight" section="icmp-options">ICMP options</DocLink>
* <DocLink id="enObservabilitySyntheticsLightweight" section="tcp-options">TCP options</DocLink>
...
Valid options for HTTP monitors include <DocLink id="enObservabilitySyntheticsLightweight" section="common-options">all common options</DocLink>
...
Valid options for ICMP monitors include <DocLink id="enObservabilitySyntheticsLightweight" section="common-options">all common options</DocLink>
...
Valid options for TCP monitors include <DocLink id="enObservabilitySyntheticsLightweight" section="common-options">all common options</DocLink>
