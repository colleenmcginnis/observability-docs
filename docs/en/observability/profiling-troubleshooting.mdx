---
id: enObservabilityProfilingTroubleshooting
slug: /en/observability/profiling-troubleshooting
title: Troubleshoot your Universal Profiling agent deployment
description: Description to be written
tags: []
---

<div id="profiling-troubleshooting"></div>
...
* The Universal Profiling Agent is unable to send data to your deployment. In this case, a similar message to the following is logged:
    ...
    This typically means that your ((ecloud)) cluster has not been configured for Universal Profiling. To configure your ((ecloud)) cluster, follow the steps in <DocLink id="enObservabilityProfilingGetStarted" section="configure-data-ingestion">configure data ingestion</DocLink>.
...
* The collector (part of the backend in ((ecloud)) that receives data from the Universal Profiling Agent) ran out of memory. In this case, a similar message to the following is logged:
    ...
    Verify that the collector is running by navigating to **((ecloud)) → Deployments → `<Deployment Name>` → Integrations Server** in [Elastic Cloud](https://cloud.elastic.co/home). If the **Copy endpoint** link next to **Profiling** is grayed out,
...
<div id="profiling-enable-verbose-logging"></div>
...
<div id="profiling-improve-load-time"></div>
...
<div id="profiling-troubleshoot-kubernetes"></div>
...
<div id="profiling-security-policy-enforcement"></div>
...
<div id="profiling-kubernetes-podsecuritypolicy"></div>
...
<div id="profiling-policy-engines"></div>
...
<div id="profiling-network-config"></div>
...
<div id="profiling-os-level-security"></div>
...
<div id="profiling-submit-support"></div>
...
<div id="profiling-send-feedback"></div>
