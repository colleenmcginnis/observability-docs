---
id: enObservabilityProfilingGetStarted
...
See the <DocLink id="enObservabilityProfilingTroubleshooting" section="send-feedback">send feedback</DocLink> section of the troubleshooting documentation for more information.
...
To set up Universal Profiling on your ((ecloud)) deployment, you need to <DocLink id="enObservabilityProfilingGetStarted" section="configure-data-ingestion">configure data ingestion</DocLink> first.
...
If you're upgrading from a previous version with Universal Profiling enabled, see the <DocLink id="enObservabilityProfilingUpgrade">upgrade guide</DocLink>.
...
1. <DocLink id="enObservabilityProfilingGetStarted" section="install-the-universal-profiling-agent-using-the-((agent))">Install the Universal Profiling Agent using the ((agent))</DocLink>
1. <DocLink id="enObservabilityProfilingGetStarted" section="install-the-universal-profiling-agent-in-standalone-mode">Install the Universal Profiling Agent in standalone mode</DocLink>
