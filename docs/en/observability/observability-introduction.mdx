---
id: enObservabilityObservabilityIntroduction
slug: /en/observability/observability-introduction
...
![Summary of Services on the ((observability)) overview page](images/apm.png)
...
For more information, see <DocLink id="enObservabilityApm">Application performance monitoring (APM)</DocLink>.
...
![Summary of Hosts on the ((observability)) overview page](images/metrics-summary.png)
...
For more information, see <DocLink id="enObservabilityAnalyzeMetrics">Infrastructure Monitoring</DocLink>.
...
![Summary of ((user-experience)) metrics on the ((observability)) overview page](images/obs-overview-ue.png)
...
For more information, see <DocLink id="enObservabilityUserExperience">((user-experience))</DocLink>.
...
![Summary of Log Events on the ((observability)) overview page](images/log-rate.png)
...
For more information, see <DocLink id="enObservabilityMonitorLogs">Log monitoring</DocLink>.
...
For more information, see <DocLink id="enObservabilityMonitorUptimeSynthetics">Synthetic monitoring</DocLink>.
...
For more information, see <DocLink id="enObservabilityUniversalProfiling">Universal Profiling</DocLink>.
...
![Summary of Alerts on the ((observability)) overview page](images/alerts-overview.png)

You can then see more details on these alerts by clicking **Show alerts**.

For more information, see <DocLink id="enObservabilityCreateAlerts">Alerting</DocLink>.