---
id: enObservabilityMonitorUptimeSynthetics
...
directly in the <DocLink id="enObservabilitySyntheticsGetStartedUi">((synthetics-app))</DocLink> or managed externally
using <DocLink id="enObservabilitySyntheticsGetStartedProject">projects</DocLink>.
...
<DocLink id="enObservabilitySyntheticsPrivateLocation">((private-location))s</DocLink>.

To view result data from lightweight monitors running through ((heartbeat)) and configured with
a traditional `heartbeat.yml` file, use the <DocLink id="enObservabilityUptimeIntro">((uptime-app))</DocLink> instead of the ((synthetics-app)).
...
* <DocLink id="enObservabilityMonitorUptimeSynthetics" section="lightweight-https-tcp-and-icmp-monitors">Lightweight HTTP/S, TCP, and ICMP monitors</DocLink>
* <DocLink id="enObservabilityMonitorUptimeSynthetics" section="browser-monitors">Browser monitors</DocLink>
...
To set up your first monitor, refer to <DocLink id="enObservabilitySyntheticsGetStarted">Get started</DocLink>.
