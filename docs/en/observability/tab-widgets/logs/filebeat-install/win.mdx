...
1. Download the ((filebeat)) Windows zip file: [https\://artifacts.elastic.co/downloads/beats/filebeat/filebeat-((version))-windows-x86_64.zip](https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-((version))-windows-x86_64.zip)
