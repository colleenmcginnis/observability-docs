---
id: enObservabilitySyntheticsMonitorUse
slug: /en/observability/synthetics-monitor-use
...
After <DocLink id="enObservabilitySyntheticsCreateTest">writing synthetic journeys</DocLink>, you can use `monitor.use`
...
* **Specify where the monitors should run.** You can run monitors on Elastic's global managed testing infrastructure
    or <DocLink id="enObservabilitySyntheticsPrivateLocation">create a ((private-location))</DocLink> to run monitors from your own premises.
...
For more details, refer to <DocLink id="enObservabilitySyntheticsConfiguration">Configure Synthetics projects</DocLink>.
