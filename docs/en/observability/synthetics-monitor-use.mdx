...
After <DocLink slug="/en/observability/synthetics-create-test">writing synthetic journeys</DocLink>, you can use `monitor.use`
...
* **Specify where the monitors should run.** You can run monitors on Elastic's global managed testing infrastructure
    or <DocLink slug="/en/observability/synthetics-private-location">create a ((private-location))</DocLink> to run monitors from your own premises.
...
For more details, refer to <DocLink slug="/en/observability/synthetics-configuration">Configure Synthetics projects</DocLink>.
