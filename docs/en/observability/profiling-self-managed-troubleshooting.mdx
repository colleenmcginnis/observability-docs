---
id: enObservabilityProfilingSelfManagedTroubleshooting
slug: /en/observability/profiling-self-managed-troubleshooting
title: Troubleshoot the Universal Profiling backend
description: Description to be written
tags: []
---

<div id="profiling-self-managed-troubleshooting"></div>
...
<div id="application_behavior"></div>

## Application behavior

<div id="missing_stack_traces_in_the_ui"></div>
...
1. symbolizer is not starting up properly: the symbolizer may be crashing on startup, possibly due to misconfigurations,
    or it may be stuck in a loop (when deployed through an orchestration system): check the logs for any errors

<div id="general_troubleshooting"></div>

## General troubleshooting

<div id="capacity_planning"></div>
...
Even if the capacity of the backend services was planned based on the number of Universal Profiling Agents as suggested in <DocLink id="enObservabilityProfilingSelfManagedOps" section="resource-guide">Sizing guidance</DocLink>,
...
<div id="inspecting_the_metrics"></div>
...
Refer to <DocLink id="enObservabilityProfilingSelfManagedOps" section="metrics">Metrics</DocLink> for instructions on how to expose metrics.
...
The same configuration option can be set through the CLI flags, as detailed in <DocLink id="enObservabilityProfilingSelfManagedOps" section="use-cli-flags-to-override-configuration-file-values">Use CLI flags to override configuration file values"</DocLink>.

When running the backend services in verbose mode, the logs will be helpful to troubleshoot issues.

<DocCallOut title="Important" color="warning">
Debug logs create an output that is unsuited for long-running production deployments.
