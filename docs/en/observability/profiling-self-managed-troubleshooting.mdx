...
Even if the capacity of the backend services was planned based on the number of Universal Profiling Agents as suggested in <DocLink slug="/en/observability/profiling-self-managed-ops" section="resource-guide">Sizing guidance</DocLink>,
...
Refer to <DocLink slug="/en/observability/profiling-self-managed-ops" section="metrics">Metrics</DocLink> for instructions on how to expose metrics.
...
The same configuration option can be set through the CLI flags, as detailed in <DocLink slug="/en/observability/profiling-self-managed-ops" section="use-cli-flags-to-override-configuration-file-values">Use CLI flags to override configuration file values"</DocLink>.
