...
<DocLink slug="/en/observability/monitor-azure-native">Monitor Microsoft Azure with the Azure Native ISV Service</DocLink>.
...
series, visit the <DocLink slug="/en/observability/observability-tutorials">Tutorials</DocLink> page.
