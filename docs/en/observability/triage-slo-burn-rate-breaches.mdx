---
id: enObservabilityTriageSloBurnRateBreaches
slug: /en/observability/triage-slo-burn-rate-breaches
title: Triage SLO burn rate breaches
description: Description to be written
tags: []
---

<div id="triage-slo-burn-rate-breaches"></div>

SLO burn rate breaches occur when the percentage of bad events over a specified time period exceeds the threshold set in your <DocLink id="enObservabilitySloBurnRateAlert">SLO burn rate rule</DocLink>.
...
1. Go to **((observability))** → **Alerts** (or open the SLO and click **Alerts**).
1. From the Alerts table, click the ![More actions](images/icons/boxesHorizontal.svg) icon next to the alert and select **View alert details**.
...
* Click the ![Actions](images/icons/boxesVertical.svg) icon and select **Add to case** to add the alert to a new or existing case. To learn more, refer to <DocLink id="enObservabilityCreateCases">Cases</DocLink>.
* Click the ![Actions](images/icons/boxesVertical.svg) icon and select **Mark as untracked**.
