...
SLO burn rate breaches occur when the percentage of bad events over a specified time period exceeds the threshold set in your <DocLink slug="/en/observability/slo-burn-rate-alert">SLO burn rate rule</DocLink>.
...
* Click the ![Actions](images/icons/boxesVertical.svg) icon and select **Add to case** to add the alert to a new or existing case. To learn more, refer to <DocLink slug="/en/observability/create-cases">Cases</DocLink>.
