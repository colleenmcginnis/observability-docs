...
1. <DocLink slug="/en/observability/create-alerts-rules">Create (or edit) an alerting rule</DocLink> and specify the conditions that must be met for the alert to fire.
...
For more information, refer to <DocLink slug="/en/observability/obs-ai-assistant" section="token-limits">Token limits</DocLink>.
...
To learn more about alerting, actions, and connectors, refer to <DocLink slug="/en/observability/create-alerts">Alerting</DocLink>.
