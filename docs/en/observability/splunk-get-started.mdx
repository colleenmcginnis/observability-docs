---
id: enObservabilitySplunkGetStarted
...
<DocLink id="enObservabilityLogsMetricsGetStarted" section="step-4-monitor-nginx-logs-and-metrics">Ingest logs, metrics, and uptime data</DocLink>.
