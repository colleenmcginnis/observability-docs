---
id: enObservabilitySyntheticsConfiguration
...
the tests based on environments, look at the <DocLink id="enObservabilitySyntheticsParamsSecrets" section="project-config-file">dynamic configuration</DocLink> documentation.
...
journey using <DocLink id="enObservabilitySyntheticsMonitorUse">`monitor.use`</DocLink>.
...
Default values to be applied to _all_ monitors when using the <DocLink id="enObservabilitySyntheticsCommandReference" section="elasticsynthetics-push">`@elastic/synthetics` `push` command</DocLink>.

<MonitorConfigOptions />

For information on configuring monitors individually, refer to:

* <DocLink id="enObservabilitySyntheticsMonitorUse">Configure individual browser monitors</DocLink> for browser monitors
* <DocLink id="enObservabilitySyntheticsLightweight">Configure lightweight monitors</DocLink> for lightweight monitors
