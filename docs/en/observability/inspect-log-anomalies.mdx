---
id: enObservabilityInspectLogAnomalies
slug: /en/observability/inspect-log-anomalies
title: Inspect log anomalies
description: Description to be written
tags: []
---

<div id="inspect-log-anomalies"></div>
...
[((ml-app)) app](((kibana-ref))/xpack-ml-anomalies.html).
...
<div id="enable-anomaly-detection"></div>
...
1. Choose a time range for the ((ml)) analysis.
1. Add the Indices that contain the logs you want to analyze.
1. Click **Create ((ml-init)) job**.
1. You're now ready to explore your log partitions.
...
[`event.dataset`](((ecs-ref))/ecs-event.html) field.
...
![Anomalies chart](images/anomalies-chart.png)
...
[Anomaly Explorer in ((ml-app))](((ml-docs))/ml-gs-results.html).
