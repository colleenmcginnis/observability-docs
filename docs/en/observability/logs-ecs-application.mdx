---
id: enObservabilityLogsEcsApplication
...
* <DocLink id="enObservabilityLogsEcsApplication" section="ecs-loggers">ECS loggers</DocLink>: plugins for your logging libraries that reformat your logs into ECS format.
* <DocLink id="enObservabilityLogsEcsApplication" section="apm-agent-ecs-reformatting">APM agent ECS reformatting</DocLink>: Java, Ruby, and Python ((apm-agent))s automatically reformat application logs to ECS format without a logger.
...
1. <DocLink id="enObservabilityLogsEcsApplication" section="enable-log-ecs-reformatting">Enable ((apm-agent)) reformatting</DocLink>
1. <DocLink id="enObservabilityLogsEcsApplication" section="ingest-logs">Ingest logs with ((filebeat)) or ((agent))</DocLink>
1. <DocLink id="enObservabilityLogsEcsApplication" section="view-logs">View logs in Log Explorer</DocLink>
...
* <DocLink id="enObservabilityLogsEcsApplication" section="ingest-logs-with-((filebeat))">((filebeat))</DocLink>: A lightweight data shipper that sends log data to your project.
* <DocLink id="enObservabilityLogsEcsApplication" section="ingest-logs-with-((agent))">((agent))</DocLink>: A single agent for logs, metrics, security data, and threat prevention. With Fleet, you can centrally manage ((agent)) policies and lifecycles directly from your project.
...
Refer to the <DocLink id="enObservabilityLogsFilterAndAggregate">Filter and aggregate logs</DocLink> documentation for more information on viewing and filtering your logs in ((kib)).
