---
id: enObservabilityMonitorAmazonKinesis
slug: /en/observability/monitor-amazon-kinesis
title: Monitor Amazon Kinesis data streams
...
<div id="monitor-amazon-kinesis"></div>
...
stream. The Elastic
[Amazon Kinesis Data Stream integration](((integrations-docs))/aws/kinesis) collects
...
<div id="get-started-kinesis"></div>

## Get started

To collect Kinesis data stream metrics from Amazon CloudWatch, you typically
need to install the Elastic
[Amazon Kinesis Data Stream integration](((integrations-docs))/aws/kinesis) and
deploy an ((agent)).
...
export let integration_name = "Amazon Kinesis Data Stream"
...
other ways, refer to [Adding data to ((es))](((cloud))/ec-cloud-ingest-data.html).

<div id="dashboard-kinesis"></div>
...
![Screenshot showing the Kinesis overview dashboard](images/kinesis-dashboard.png)

<div id="metrics-to-watch-kinesis"></div>
...
the [Amazon Kinesis Data Stream integration](((integrations-docs))/aws/kinesis)
docs.
