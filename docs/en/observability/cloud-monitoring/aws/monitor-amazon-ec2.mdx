---
id: enObservabilityMonitorAmazonEc2
slug: /en/observability/monitor-amazon-ec2
title: Monitor Amazon Cloud Compute (EC2)
...
<div id="monitor-amazon-ec2"></div>

[Elastic Compute Cloud (Amazon EC2)](https://aws.amazon.com/ec2) enables
...
Elastic [Amazon EC2 integration](((integrations-docs))/aws/ec2) collects metrics
...
[Amazon EC2 documentation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-cloudwatch-new.html).
...
<div id="get-started-ec2"></div>

## Get started

To collect EC2 metrics, you typically need to install the Elastic
[Amazon EC2 integration](((integrations-docs))/aws/ec2) and deploy an ((agent)).
...
export let integration_name = "Amazon EC2"
...
![Screenshot showing the EC2 overview dashboard](images/ec2-overview-dashboard.png)
...
[Amazon EC2 integration docs](((integrations-docs))/aws/ec2).
...
[Amazon EBS integration](((integrations-docs))/aws/ebs).
...
<DocDefList>
  ...
  <DocDefDescription>
    ...
    [Amazon EC2 documentation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/TroubleshootingInstances.html).
