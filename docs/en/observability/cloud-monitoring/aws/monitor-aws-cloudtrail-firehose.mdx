...
For more information on how to set up a Amazon Data Firehose delivery stream to send data to Elastic Cloud, you can also check the <DocLink slug="/en/observability/monitor-aws-firehose">setup guide</DocLink>.
