...
**<DocLink slug="/en/observability/logs-plaintext">Plaintext application logs</DocLink>**
...
**<DocLink slug="/en/observability/logs-ecs-application">ECS formatted application logs</DocLink>**
...
**<DocLink slug="/en/observability/logs-send-application">((apm-agent)) log sending</DocLink>**
