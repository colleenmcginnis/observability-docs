...
**This approach can only be used to create lightweight monitors.** To create _browser_ monitors, use the <DocLink slug="/en/observability/synthetics-get-started">((synthetics-app))</DocLink>.
</DocCallOut>
...
**Do not use ((heartbeat)) to set up a _new_ `browser` monitor.** Instead, use the <DocLink slug="/en/observability/synthetics-get-started">((synthetics-app))</DocLink>.
...
For more information, refer to <DocLink slug="/en/observability/uptime-analyze">Analyze</DocLink>.
