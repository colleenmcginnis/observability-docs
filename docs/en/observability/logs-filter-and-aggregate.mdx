---
id: enObservabilityLogsFilterAndAggregate
...
* <DocLink id="enObservabilityLogsFilterAndAggregate" section="filter-logs">Filter logs</DocLink> — Narrow down your log data by applying specific criteria.
* <DocLink id="enObservabilityLogsFilterAndAggregate" section="aggregate-logs">Aggregate logs</DocLink> — Analyze and summarize data to find patterns and gain insight.

<div id="logs-filter-and-aggregate-prereq"></div>

## Before you get started

The examples on this page use the following ingest pipeline and index template, which you can set in **Dev Tools**. If you haven't used ingest pipelines and index templates to parse your log data and extract structured fields yet, start with the <DocLink id="enObservabilityLogsParse">Parse and organize logs</DocLink> documentation.
...
- <DocLink id="enObservabilityLogsFilterAndAggregate" section="filter-logs-in-log-explorer">Filter logs in Log Explorer</DocLink> – Filter and visualize log data in ((kib)) using Log Explorer.
- <DocLink id="enObservabilityLogsFilterAndAggregate" section="filter-logs-with-query-dsl">Filter logs with Query DSL</DocLink> – Filter log data from Dev Tools using Query DSL.
