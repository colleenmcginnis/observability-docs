...
```
[^1]: The name of the custom ((ilm-init)) policy chosen in <DocLink slug="/en/observability/profiling-index-lifecycle-management" section="step-1-create-an-index-lifecycle-policy">Step 1</DocLink>.
