...
You can use the standard JVM TI [JAVA_TOOL_OPTIONS](https://docs.oracle.com/javase/8/docs/platform/jvmti/jvmti.html#tooloptions) environment variable to do this.
It doesn't have to be explicitly specified and is picked up automatically by the JVM when it starts.

<DocCallOut title="Tip">
For JVMs that don't support this option, you can use any other environment variable --
...
* [Supported technologies](((apm-java-ref-v))/supported-technologies-details.html)
* [Advanced configuration](((apm-java-ref-v))/configuration.html)
