...
1. Click **Settings**.
    ...
    <DocTable columns={[
      ...
      <DocRow>
        ...
        <DocCell>
          Configuring fields input has been deprecated. You should adjust your indexing using the <DocLink slug="/en/observability/logs-app-fields">((logs-app)) fields</DocLink>, which use the [Elastic Common Schema (ECS) specification](((ecs-ref))/index.html).
        </DocCell>
      </DocRow>
      <DocRow>
