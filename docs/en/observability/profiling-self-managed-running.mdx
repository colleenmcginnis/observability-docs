---
id: enObservabilityProfilingSelfManagedRunning
...
1. <DocLink id="enObservabilityProfilingSelfManagedRunning" section="create-api-keys">Create API keys</DocLink> to authenticate the backend applications.
1. Run the application on <DocLink id="enObservabilityProfilingSelfManagedRunning" section="run-on-linux">Linux</DocLink> or <DocLink id="enObservabilityProfilingSelfManagedRunning" section="run-on-kubernetes">Kubernetes</DocLink>.
...
Continue to <DocLink id="enObservabilityProfilingSelfManagedRunning" section="run-on-linux">Run on Linux</DocLink> or <DocLink id="enObservabilityProfilingSelfManagedRunning" section="run-on-kubernetes">Run on Kubernetes</DocLink> for information on running the backend applications.

<div id="profiling-self-managed-running-linux"></div>

## Run on Linux

Before running the backend applications on Linux, we recommend creating <DocLink id="enObservabilityProfilingSelfManagedRunning" section="create-configuration-files">configuration files</DocLink> to manage the applications.
...
1. <DocLink id="enObservabilityProfilingSelfManagedRunning" section="os-packages-debrpm">OS packages (DEB/RPM)</DocLink>
1. <DocLink id="enObservabilityProfilingSelfManagedRunning" section="oci-containers">OCI containers</DocLink>
1. <DocLink id="enObservabilityProfilingSelfManagedRunning" section="binary">Binary</DocLink>: orchestrated with your configuration management system of choice (Ansible, Puppet, Chef, Salt, etc.)
...
Customize the content of the `output.elasticsearch` section, using the Elasticsearch endpoint and <DocLink id="enObservabilityProfilingSelfManagedRunning" section="create-api-keys">API key</DocLink> to set the `hosts` and `api_key` values, respectively.
...
Refer to <DocLink id="enObservabilityProfilingSelfManagedTroubleshooting">Troubleshooting Universal Profiling backend</DocLink> for more information on troubleshooting possible errors in the logs.
...
For the applications' configuration, you can reuse the configuration files detailed in <DocLink id="enObservabilityProfilingSelfManagedRunning" section="create-configuration-files">"Create configuration files"</DocLink> and pass them to Helm as a values file (using the `--values` of `-f` flags), or copy them in the `values.yaml` file.
...
Continue to <DocLink id="enObservabilityProfilingSelfManagedInstallNextSteps">Step 5: Next steps</DocLink>.
