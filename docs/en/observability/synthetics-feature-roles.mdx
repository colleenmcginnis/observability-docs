---
id: enObservabilitySyntheticsFeatureRoles
...
* <DocLink id="enObservabilitySyntheticsRoleSetup">Setup role</DocLink> for enabling Monitor Management.
* <DocLink id="enObservabilitySyntheticsRoleWrite">Writer role</DocLink>  for creating, modifying, and deleting monitors.
* <DocLink id="enObservabilitySyntheticsRoleRead">Reader role</DocLink> for ((kib)) users who need to view and
