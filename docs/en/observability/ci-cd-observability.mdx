...
1. Click the _Advanced_ button to choose a storage integration strategy.
    ...
    * **Store pipeline logs in Elastic and visualize logs both in Elastic and through Jenkins**,
        ...
        Read more in <DocLink slug="/en/observability/ci-cd-observability" section="visualize-logs-in-both-((kib))-and-jenkins">Visualize logs in both ((kib)) and Jenkins</DocLink> below.
    ...
    * **Store pipeline logs in Elastic and visualize logs exclusively in Elastic**,
        ...
        Read more in <DocLink slug="/en/observability/ci-cd-observability" section="visualize-logs-exclusively-in-((kib))">Visualize logs exclusively in ((kib))</DocLink> below.
...
to inject OpenTelemetry configuration as environment variables. For more details, refer to <DocLink slug="/en/observability/ci-cd-observability" section="install-the-opentelemetry-plugin">Install the OpenTelemetry plugin</DocLink>.
