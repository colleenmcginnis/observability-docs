---
id: enObservabilitySyntheticsSupportMatrix
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      * For creating and managing lightweight and browser monitors configured through the <DocLink id="enObservabilitySyntheticsGetStartedUi">((synthetics-app))</DocLink>
      * For reporting for lightweight and browser monitors configured through the <DocLink id="enObservabilitySyntheticsGetStartedUi">((synthetics-app))</DocLink> and/or <DocLink id="enObservabilitySyntheticsGetStartedProject">((project-monitors-cap))</DocLink>
  ...
  <DocRow>
    ...
    <DocCell>
      For creating and managing lightweight and browser monitors configured as <DocLink id="enObservabilitySyntheticsGetStartedProject">((project-monitors-cap))</DocLink>
    </DocCell>
  </DocRow>
  <DocRow>
    <DocCell>
    ...
    <DocCell>
      Elastic’s infrastructure for running lightweight and browser monitors configured through the <DocLink id="enObservabilitySyntheticsGetStartedUi">((synthetics-app))</DocLink> and/or <DocLink id="enObservabilitySyntheticsGetStartedProject">((project-monitors-cap))</DocLink>
