---
id: enObservabilityViewInfrastructureMetrics
...
* **Kubernetes Pod logs** to <DocLink id="enObservabilityMonitorLogs">view corresponding logs</DocLink> in the ((logs-app)).
* **Kubernetes Pod APM traces** to [view corresponding APM traces](((kibana-ref))/traces.html) in the ((apm-app)).
* **Kubernetes Pod in Uptime** to <DocLink id="enObservabilityMonitorUptimeSynthetics">view related uptime information</DocLink> in the ((uptime-app)).
