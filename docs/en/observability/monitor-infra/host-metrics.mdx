---
slug: /en/observability/host-metrics
title: Host metrics
...
* <DocLink slug="/en/observability/host-metrics" section="hosts-metrics">Hosts</DocLink>
* <DocLink slug="/en/observability/host-metrics" section="cpu-usage-metrics">CPU usage</DocLink>
* <DocLink slug="/en/observability/host-metrics" section="memory-metrics">Memory</DocLink>
* <DocLink slug="/en/observability/host-metrics" section="log-metrics">Log</DocLink>
* <DocLink slug="/en/observability/host-metrics" section="network-metrics">Network</DocLink>
* <DocLink slug="/en/observability/host-metrics" section="network-metrics">Disk</DocLink>
