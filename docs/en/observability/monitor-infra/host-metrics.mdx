...
* <DocLink id="enObservabilityHostMetrics" section="hosts-metrics">Hosts</DocLink>
* <DocLink id="enObservabilityHostMetrics" section="cpu-usage-metrics">CPU usage</DocLink>
* <DocLink id="enObservabilityHostMetrics" section="memory-metrics">Memory</DocLink>
* <DocLink id="enObservabilityHostMetrics" section="log-metrics">Log</DocLink>
* <DocLink id="enObservabilityHostMetrics" section="network-metrics">Network</DocLink>
* <DocLink id="enObservabilityHostMetrics" section="network-metrics">Disk</DocLink>
