...
this behavior, refer to <DocLink slug="/en/observability/configure-settings">Configure settings</DocLink>.

To learn more about the metrics shown in the ((infrastructure-app)), refer to
the <DocLink slug="/en/observability/metrics-reference">Metrics reference</DocLink> documentation.
