---
id: enObservabilityAnalyzeMetrics
slug: /en/observability/analyze-metrics
...
<DocTable columns={[
  ...
  <DocRow>
    <DocCell>**Metrics Explorer**</DocCell>
    <DocCell>
...
this behavior, refer to <DocLink id="enObservabilityConfigureSettings">Configure settings</DocLink>.

To learn more about the metrics shown in the ((infrastructure-app)), refer to
the <DocLink id="enObservabilityMetricsReference">Metrics reference</DocLink> documentation.
