---
id: enObservabilityAnalyzeHosts
...
<DocLink id="enObservabilityMetricsReference">Metrics reference</DocLink> documentation.
...
* Each host name is an active link to a <DocLink id="enObservabilityAnalyzeHosts" section="view-host-details">host details</DocLink> page,
...
For more information about creating and viewing alerts, refer to <DocLink id="enObservabilityCreateAlerts">Alerting</DocLink>.
</DocCallOut>
...
To see metrics for a specific host, refer to <DocLink id="enObservabilityAnalyzeHosts" section="view-host-details">View host details</DocLink>.
...
<DocLink id="enObservabilityConfigureDataSources">Configure data sources</DocLink>.
</DocCallOut>

Click **Open in Logs** to tail your log files. For more information, refer to
<DocLink id="enObservabilityTailLogs">Tail log files</DocLink>.

To see logs for a specific host, refer to <DocLink id="enObservabilityAnalyzeHosts" section="view-host-details">View host details</DocLink>.
...
To see alerts for a specific host, refer to <DocLink id="enObservabilityAnalyzeHosts" section="view-host-details">View host details</DocLink>.
...
To learn more about creating and managing rules, refer to <DocLink id="enObservabilityCreateAlerts">Alerting</DocLink>.
...
* <DocLink id="enObservabilityAnalyzeHosts" section="the-chart-interval-is-too-short">The chart interval is too short</DocLink>
* <DocLink id="enObservabilityAnalyzeHosts" section="data-is-missing">Data is missing</DocLink>
* <DocLink id="enObservabilityAnalyzeHosts" section="the-chart-interval-is-too-short-and-data-is-missing">The chart interval is too short and data is missing</DocLink>
