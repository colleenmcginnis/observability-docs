---
slug: /en/observability/analyze-hosts
...
* Each host name is an active link to a <DocLink slug="/en/observability/analyze-hosts" section="view-host-details">host details</DocLink> page,
...
For more information about creating and viewing alerts, refer to <DocLink slug="/en/observability/create-alerts">Alerting</DocLink>.
</DocCallOut>
...
[((kib)) concepts](((kibana-ref))/kibana-concepts-analysts.html).
...
To see metrics for a specific host, refer to <DocLink slug="/en/observability/analyze-hosts" section="view-host-details">View host details</DocLink>.
...
<DocCallOut title="Tip">
This view uses the log sources and column settings specified in the
Logs app. To add log sources or columns (such as host name), refer to
<DocLink slug="/en/observability/configure-data-sources">Configure data sources</DocLink>.
</DocCallOut>

Click **Open in Logs** to tail your log files. For more information, refer to
<DocLink slug="/en/observability/tail-logs">Tail log files</DocLink>.

To see logs for a specific host, refer to <DocLink slug="/en/observability/analyze-hosts" section="view-host-details">View host details</DocLink>.
...
To see alerts for a specific host, refer to <DocLink slug="/en/observability/analyze-hosts" section="view-host-details">View host details</DocLink>.
...
To learn more about creating and managing rules, refer to <DocLink slug="/en/observability/create-alerts">Alerting</DocLink>.
...
icon <DocIcon name="expand" title="Expand icon" /> to display the host details overlay.
...
* <DocLink slug="/en/observability/analyze-hosts" section="the-chart-interval-is-too-short">The chart interval is too short</DocLink>
* <DocLink slug="/en/observability/analyze-hosts" section="data-is-missing">Data is missing</DocLink>
* <DocLink slug="/en/observability/analyze-hosts" section="the-chart-interval-is-too-short-and-data-is-missing">The chart interval is too short and data is missing</DocLink>
