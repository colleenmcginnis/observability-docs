...
view filters based on the following predefined metrics or you can add <DocLink slug="/en/observability/view-infrastructure-metrics" section="add-custom-metrics">custom metrics</DocLink>.
...
<DocLink slug="/en/observability/metrics-app-fields">((infrastructure-app)) field reference</DocLink>.