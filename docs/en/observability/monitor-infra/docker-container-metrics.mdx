---
id: enObservabilityDockerContainerMetrics
slug: /en/observability/docker-container-metrics
...
view filters based on the following predefined metrics or you can add <DocLink id="enObservabilityViewInfrastructureMetrics" section="add-custom-metrics">custom metrics</DocLink>.
...
<DocLink id="enObservabilityMetricsAppFields">((infrastructure-app)) field reference</DocLink>.