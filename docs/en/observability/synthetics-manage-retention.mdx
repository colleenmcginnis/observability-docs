---
id: enObservabilitySyntheticsManageRetention
slug: /en/observability/synthetics-manage-retention
title: Manage data retention
description: Description to be written
tags: []
---

<div id="synthetics-manage-retention"></div>
...
<div id="synthetics-manage-retention-data-streams"></div>
...
<div id="synthetics-manage-retention-customize"></div>
...
1. Navigate to [((kib)) index management](((ref))/index-mgmt.html).
