...
* <DocLink slug="/en/observability/synthetics-create-test">Write a synthetic test</DocLink>
* <DocLink slug="/en/observability/synthetics-create-test" section="test-locally">Test locally</DocLink>
* <DocLink slug="/en/observability/synthetics-monitor-use">Configure individual browser monitors</DocLink>
* <DocLink slug="/en/observability/synthetics-params-secrets">Work with params and secrets</DocLink>
* <DocLink slug="/en/observability/synthetics-recorder">Use the Synthetics Recorder</DocLink>
