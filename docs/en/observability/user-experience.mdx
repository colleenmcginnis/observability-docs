...
title: Real user monitoring (((user-experience)))
...
![((user-experience)) tab](images/user-experience-tab.png)

<div id="why-user-experience"></div>
...
{/* footnote:[Source and more info: [neilpatel.com](https://neilpatel.com/blog/loading-time/)] */}
...
{/* footnote:[Source and more info: [fastcompany.com](https://www.fastcompany.com/1825005/how-one-second-could-cost-amazon-16-billion-sales)] */}
{/* In short, a good ((user-experience)) keeps your users happy and improves your website's odds of success. */}
{/* -------------------------------------------------------------------------------------------------------------- */}

<div id="how-user-experience-works"></div>

## How does ((user-experience)) work?

((user-experience)) metrics are powered by the [APM Real User Monitoring (RUM) agent](((apm-rum-ref))).
The RUM agent uses browser timing APIs, like [Navigation Timing](https://w3c.github.io/navigation-timing/),
[Resource Timing](https://w3c.github.io/resource-timing/), [Paint Timing](https://w3c.github.io/paint-timing/),
and [User Timing](https://w3c.github.io/user-timing/), to capture ((user-experience))
...
It only takes a few minutes to [get started](((observability-guide))/apm-rum.html).

<div id="user-experience-tab"></div>

## ((user-experience)) in ((kib))

<div id="user-experience-page-load"></div>
...
![((user-experience)) page load duration metrics](images/page-load-duration.png)

<div id="user-experience-metrics"></div>
...
![((user-experience)) metrics](images/user-exp-metrics.png)

{/* This is collapsed by default */}

<DocAccordion buttonContent="Metric reference">

<DocDefList>
  <DocDefTerm>First contentful paint</DocDefTerm>
  <DocDefDescription>
    ...
    The agent uses the [Paint timing API](https://www.w3.org/TR/paint-timing/#first-contentful-paint) available
    in the browser to capture the timing information.
    footnote:[More information: [developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Glossary/First_contentful_paint)]
  </DocDefDescription>

  <DocDefTerm>Total blocking time</DocDefTerm>
  <DocDefDescription>
    ...
    Total blocking time is a great companion metric for [Time to interactive](https://web.dev/tti/)
    ...
    footnote:[More information: [web.dev](https://web.dev/tbt/)]
  </DocDefDescription>

  <DocDefTerm>`Long Tasks`</DocDefTerm>
  <DocDefDescription>
    ...
    from being executed.
    footnote:[More information: [developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/API/Long_Tasks_API)]
  </DocDefDescription>

  <DocDefTerm>Number of long tasks</DocDefTerm>
  <DocDefDescription>
    The number of long tasks.
  </DocDefDescription>

  <DocDefTerm>Longest long task duration</DocDefTerm>
  <DocDefDescription>
    Duration of the longest long task on the page.
  </DocDefDescription>

  <DocDefTerm>Total long tasks duration</DocDefTerm>
  <DocDefDescription>
...
<div id="user-experience-core-vitals"></div>

#### Core Web Vitals

[Core Web Vitals](https://web.dev/vitals/) is a recent initiative from Google to introduce a new set of
...
<DocDefList>
  <DocDefTerm>Largest contentful paint (LCP)</DocDefTerm>
  <DocDefDescription>
      ...
      footnote:[Source: [web.dev](https://web.dev/lcp/)]
  </DocDefDescription>
  <DocDefTerm>Interaction to next paint (INP)</DocDefTerm>
  <DocDefDescription>
      ...
      footnote:[Source: [web.dev](https://web.dev/articles/inp)]
  </DocDefDescription>
</DocDefList>

<DocCallOut title="Note">

  Previous ((kib)) versions included the metric [First input delay (FID)](https://web.dev/fid/) in the User Experience app.
  ...
  |  |  |  |
  |---|---|---|
  |  | **Kibana version ≥((nbsp))8.12** | **Kibana version \<((nbsp))8.12** |
  | **RUM agent version ≥((nbsp))5.16.0** | INP data will be visible. | FID data will be visible. |
  | **RUM agent version \<((nbsp))5.16.0** | The INP section will be empty. | FID data will be visible. |

  RUM agent version ≥((nbsp))5.16.0 will continue to collect FID metrics so, while FID metrics are not shown in the User Experience app in ((kib)) versions 8.12 and later, you can choose to visualize FID metrics in a [custom dashboard](((kibana-ref))/create-a-dashboard-of-panels-with-web-server-data.html) or using [Lens](((kibana-ref))/lens.html).
...
Cumulative layout shift (CLS)
    ...
    footnote:[Source: [web.dev](https://web.dev/cls/)]

<DocCallOut title="Tip">
  [Beginning in May 2021](https://webmasters.googleblog.com/2020/11/timing-for-page-experience.html),
  ...
  position without needing to leverage [AMP](https://amp.dev/).
  footnote:[Source: [webmasters.googleblog.com](https://webmasters.googleblog.com/2020/05/evaluating-page-experience.html)]
</DocCallOut>

<div id="user-experience-distribution"></div>
...
![((user-experience)) visitor breakdown](images/visitor-breakdown.png)

<div id="user-experience-errors"></div>
...
![((user-experience)) JavaScript errors](images/js-errors.png)

Open error messages in APM for additional analysis tools,
like occurrence rates, transaction ids, user data, and more.

<div id="user-experience-feedback"></div>

### Feedback and troubleshooting

Have a question? Want to leave feedback? Visit the
[((user-experience)) discussion forum](https://discuss.elastic.co/c/observability/user-experience/87).

<div id="user-experience-references"></div>

#### References

3: More information: developer.mozilla.org

4: More information: web.dev

5: More information: developer.mozilla.org
...
9: Source: webmasters.googleblog.com
