...
![Header at the top of the individual monitor page for all monitor types in the ((synthetics-app))](images/synthetics-analyze-individual-monitor-header.png)
...
![Details in the Overview tab on the individual monitor page for all monitor types in the ((synthetics-app))](images/synthetics-analyze-individual-monitor-details.png)
...
included the in <DocLink slug="/en/observability/synthetics-analyze" section="details-for-one-run">Details for one run</DocLink> section below.

![The History tab on the individual monitor page for all monitor types in the ((synthetics-app))](images/synthetics-analyze-individual-monitor-history.png)

If the monitor is configured to <DocLink slug="/en/observability/synthetics-configuration" section="monitor">retest on failure</DocLink>,
you'll see retests listed in the **Test runs** table. Runs that are retests include a
rerun icon (![Refresh icon](images/icons/refresh.svg)) next to the result badge.

![A failed run and a retest in the table of test runs in the ((synthetics-app))](images/synthetics-retest.png)
...
that is included the in <DocLink slug="/en/observability/synthetics-analyze" section="details-for-one-run">Details for one run</DocLink> section below.

![The Errors tab on the individual monitor page for all monitor types in the ((synthetics-app))](images/synthetics-analyze-individual-monitor-errors.png)
...
* A list of the **last 10 test runs** that link to the <DocLink slug="/en/observability/synthetics-analyze" section="details-for-one-run">details for each run</DocLink>.

![Individual journey page for browser monitors in the ((synthetics-app))](images/synthetics-analyze-journeys-over-time.png)
...
* The latest run of the full journey by clicking **<DocIcon type="inspect" title="Inspect" /> View test run**
    ...
    This will take you to the view described below in <DocLink slug="/en/observability/synthetics-analyze" section="details-for-one-run">Details for one run</DocLink>.
...
* An individual step in this run by clicking the performance breakdown icon
    ...
    This will take you to the view described below in <DocLink slug="/en/observability/synthetics-analyze" section="details-for-one-step">Details for one step</DocLink>.
...
![Step carousel on a page detailing one run of a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-run-code-executed.png)
...
Read more about step-level metrics below in <DocLink slug="/en/observability/synthetics-analyze" section="timing">Timing</DocLink> and
<DocLink slug="/en/observability/synthetics-analyze" section="metrics">Metrics</DocLink>.
...
{/* Screenshot of the viz */}
![Step list on a page detailing one run of a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-run-compare-steps.png)
...
Customize screenshot behavior for all monitors in the <DocLink slug="/en/observability/synthetics-configuration">configuration file</DocLink>,
for one monitor using <DocLink slug="/en/observability/synthetics-monitor-use">`monitor.use`</DocLink>, or for a run using
the <DocLink slug="/en/observability/synthetics-command-reference" section="elasticsynthetics">CLI</DocLink>.
...
{/* Screenshot of the viz */}
![Screenshot for one step in a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-step-screenshot.png)
...
signal to look at more granular information in the <DocLink slug="/en/observability/synthetics-analyze" section="network-requests">Network requests</DocLink> section.

{/* Screenshot of the viz */}
![Network timing visualization for one step in a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-step-timing.png)
...
{/* Screenshot of the viz */}
![Metrics visualization for one step in a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-step-metrics.png)
...
{/* Screenshot of the viz */}
![Object visualization for one step in a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-step-object.png)
...
(as defined in the <DocLink slug="/en/observability/synthetics-analyze" section="timing">Timing</DocLink> section above) and
...
{/* Screenshot of the viz */}
![Network requests waterfall visualization for one step in a browser monitor in the ((synthetics-app))](images/synthetics-analyze-one-step-network.png)
