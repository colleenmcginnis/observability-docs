---
id: enObservabilitySyntheticsAnalyze
...
included the in <DocLink id="enObservabilitySyntheticsAnalyze" section="details-for-one-run">Details for one run</DocLink> section below.
...
If the monitor is configured to <DocLink id="enObservabilitySyntheticsConfiguration" section="monitor">retest on failure</DocLink>,
...
that is included the in <DocLink id="enObservabilitySyntheticsAnalyze" section="details-for-one-run">Details for one run</DocLink> section below.
...
* A list of the **last 10 test runs** that link to the <DocLink id="enObservabilitySyntheticsAnalyze" section="details-for-one-run">details for each run</DocLink>.
...
* The latest run of the full journey by clicking **<DocIcon type="inspect" title="Inspect" /> View test run**
    ...
    This will take you to the view described below in <DocLink id="enObservabilitySyntheticsAnalyze" section="details-for-one-run">Details for one run</DocLink>.
...
* An individual step in this run by clicking the performance breakdown icon
    ...
    This will take you to the view described below in <DocLink id="enObservabilitySyntheticsAnalyze" section="details-for-one-step">Details for one step</DocLink>.
...
Read more about step-level metrics below in <DocLink id="enObservabilitySyntheticsAnalyze" section="timing">Timing</DocLink> and
<DocLink id="enObservabilitySyntheticsAnalyze" section="metrics">Metrics</DocLink>.
...
Customize screenshot behavior for all monitors in the <DocLink id="enObservabilitySyntheticsConfiguration">configuration file</DocLink>,
for one monitor using <DocLink id="enObservabilitySyntheticsMonitorUse">`monitor.use`</DocLink>, or for a run using
the <DocLink id="enObservabilitySyntheticsCommandReference" section="elasticsynthetics">CLI</DocLink>.
...
signal to look at more granular information in the <DocLink id="enObservabilitySyntheticsAnalyze" section="network-requests">Network requests</DocLink> section.
...
(as defined in the <DocLink id="enObservabilitySyntheticsAnalyze" section="timing">Timing</DocLink> section above) and
