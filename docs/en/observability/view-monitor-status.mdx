...
* Show host, pod, or container logs in the <DocLink slug="/en/observability/monitor-logs">((logs-app))</DocLink>.
* Show APM data in the [((apm-app))](((kibana-ref))/traces.html).
* Show host, pod, or container metrics in the <DocLink slug="/en/observability/analyze-metrics">((infrastructure-app))</DocLink>.
