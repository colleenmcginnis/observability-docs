---
id: enObservabilityViewMonitorStatus
slug: /en/observability/view-monitor-status
title: View monitor status
description: Description to be written
tags: []
---

<div id="view-monitor-status"></div>
...
![Uptime filter bar](images/uptime-filter-bar.png)

<div id="monitor-availability"></div>
...
![Monitors chart](images/monitors-chart.png)
...
![Monitors list](images/monitors-list.png)

<div id="observability-integrations"></div>
...
* Show host, pod, or container logs in the <DocLink id="enObservabilityMonitorLogs">((logs-app))</DocLink>.
* Show APM data in the [((apm-app))](((kibana-ref))/traces.html).
* Show host, pod, or container metrics in the <DocLink id="enObservabilityAnalyzeMetrics">((infrastructure-app))</DocLink>.
