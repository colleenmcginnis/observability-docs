...
Threshold breaches occur when an ((observability)) data type reaches or exceeds the threshold set in your <DocLink slug="/en/observability/custom-threshold-alert">custom threshold rule</DocLink>.
...
* Click the <DocIcon type="boxesVertical" title="stacked boxes icon" /> icon and select **Add to case** to add the alert to a new or existing case. To learn more, refer to <DocLink slug="/en/observability/create-cases">Cases</DocLink>.
