---
id: enObservabilityTriageThresholdBreaches
slug: /en/observability/triage-threshold-breaches
title: Triage threshold breaches
description: Description to be written
tags: []
---

<div id="triage-threshold-breaches"></div>

Threshold breaches occur when an ((observability)) data type reaches or exceeds the threshold set in your <DocLink id="enObservabilityCustomThresholdAlert">custom threshold rule</DocLink>.
...
1. From the Alerts table, click the <DocIcon type="boxesHorizontal" title="horizontal boxes icon" /> icon next to the alert and select **View alert details**.
...
* Click the <DocIcon type="boxesVertical" title="stacked boxes icon" /> icon and select **Add to case** to add the alert to a new or existing case. To learn more, refer to <DocLink id="enObservabilityCreateCases">Cases</DocLink>.
* Click the <DocIcon type="boxesVertical" title="stacked boxes icon" /> icon and select **Mark as untracked**.
