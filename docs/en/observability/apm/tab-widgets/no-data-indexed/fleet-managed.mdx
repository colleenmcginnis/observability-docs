...
1. SSL isn't <DocLink slug="/en/observability/apm-common-problems" section="ssl-client-fails-to-connect">misconfigured</DocLink>.
...
see <DocLink slug="/en/observability/apm-common-response-codes">APM Server response codes</DocLink> to narrow down the possible causes.
