...
If no requests are logged, it might be that SSL is <DocLink id="enObservabilityApmCommonProblems" section="ssl-client-fails-to-connect">misconfigured</DocLink> or that the host is wrong.
