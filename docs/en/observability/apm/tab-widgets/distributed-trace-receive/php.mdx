...
1. Begin a new transaction using the agent's public API. For example, use [`ElasticApm::beginCurrentTransaction`](((apm-php-ref-v))/public-api.html#api-elasticapm-class-begin-current-transaction)
