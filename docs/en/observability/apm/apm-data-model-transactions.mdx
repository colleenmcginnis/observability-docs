---
id: enObservabilityApmDataModelTransactions
...
**Transactions** are a special kind of <DocLink id="enObservabilityApmDataModelSpans">span</DocLink> that have additional attributes associated with them.
...
If sampled, the <DocLink id="enObservabilityApmDataModelSpans">spans</DocLink> of a transaction are sent and stored as separate documents.
