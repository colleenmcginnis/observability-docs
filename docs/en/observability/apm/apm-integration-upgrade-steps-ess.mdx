---
id: enObservabilityApmIntegrationUpgradeStepsEss
...
1. <DocLink id="enObservabilityApmIntegrationUpgradeStepsEss" section="upgrade-the-((stack))">Upgrade the ((stack))</DocLink>
1. <DocLink id="enObservabilityApmIntegrationUpgradeStepsEss" section="switch-to-((agent))">Switch to ((agent))</DocLink>
1. <DocLink id="enObservabilityApmIntegrationUpgradeStepsEss" section="configure-the-apm-integration">Configure the APM integration</DocLink>
1. <DocLink id="enObservabilityApmIntegrationUpgradeStepsEss" section="scale-apm-and-((fleet))">Scale APM and ((fleet))</DocLink>
