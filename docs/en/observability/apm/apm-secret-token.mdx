...
1. Make sure <DocLink slug="/en/observability/apm-agent-tls">TLS</DocLink> is enabled
1. <DocLink slug="/en/observability/apm-secret-token" section="create-a-secret-token">Create a secret token</DocLink>
1. <DocLink slug="/en/observability/apm-secret-token" section="configure-the-secret-token-in-your-apm-agents">Configure the secret token in your APM agents</DocLink>
