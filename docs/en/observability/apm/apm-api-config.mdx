---
id: enObservabilityApmApiConfig
slug: /en/observability/apm-api-config
title: Elastic APM agent configuration API
description: Description to be written
tags: []
---

<div id="apm-api-config"></div>
...
<div id="apm-api-config-endpoint"></div>
...
If an <DocLink id="enObservabilityApmApiKey">API keys</DocLink> or <DocLink id="enObservabilityApmSecretToken">Secret token</DocLink> is configured, requests to this endpoint must be authenticated.

<div id="apm-api-config-api-get"></div>
...
<div id="apm-api-config-api-post"></div>
...
<div id="apm-api-config-api-response"></div>
...
<div id="apm-api-config-api-example"></div>
...
<div id="apm-api-config-api-ex-response"></div>
