...
If an <DocLink slug="/en/observability/apm-api-key">API keys</DocLink> or <DocLink slug="/en/observability/apm-secret-token">Secret token</DocLink> is configured, requests to this endpoint must be authenticated.
