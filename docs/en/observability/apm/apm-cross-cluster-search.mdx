---
id: enObservabilityApmCrossClusterSearch
slug: /en/observability/apm-cross-cluster-search
title: Cross-cluster search
description: Description to be written
tags: []
---

<div id="apm-cross-cluster-search"></div>
...
[remote clusters](((ref))/modules-remote-clusters.html) --
...
<div id="apm-set-up-cross-cluster-search"></div>

## Set up cross-cluster search

**Step 1. Set up remote clusters.**

If you're using the Hosted ((ess)), see [Enable cross-cluster search](((cloud))/ec-enable-ccs.html).
...
See [managing remote clusters](((ref))/ccr-getting-started.html) for detailed information on the setup process.

Alternatively, you can [configure remote clusters](((ref))/modules-remote-clusters.html#configuring-remote-clusters)
...
* In `kibana.yml` -- Update the [`xpack.apm.indices.*`](((kibana-ref))/apm-settings-kb.html) configuration values to
    include remote clusters.
