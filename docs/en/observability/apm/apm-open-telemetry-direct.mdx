---
id: enObservabilityApmOpenTelemetryDirect
...
* Send data to the ((stack)) from an <DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-collector">OpenTelemetry collector</DocLink>
* Send data to the ((stack)) from an <DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-agent">OpenTelemetry agent</DocLink>
...
[^6]: Credential for Elastic APM <DocLink id="enObservabilityApmSecretToken">secret token authorization</DocLink> (`Authorization: "Bearer a_secret_token"`) or <DocLink id="enObservabilityApmApiKey">API key authorization</DocLink> (`Authorization: "ApiKey an_api_key"`).
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>Fields that describe the service and the environment that the service runs in. See <DocLink id="enObservabilityApmOpenTelemetryResourceAttributes">resource attributes</DocLink> for more information.</DocCell>
  </DocRow>
  <DocRow>
...
You are now ready to collect traces and <DocLink id="enObservabilityApmOpenTelemetryCollectMetrics">metrics</DocLink> before <DocLink id="enObservabilityApmOpenTelemetryCollectMetrics" section="verify-opentelemetry-metrics-data">verifying metrics</DocLink>
and <DocLink id="enObservabilityApmOpenTelemetryCollectMetrics" section="visualize-in-((kib))">visualizing metrics</DocLink> in ((kib)).
