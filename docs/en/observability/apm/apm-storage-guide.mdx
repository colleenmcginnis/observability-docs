---
id: enObservabilityApmStorageGuide
slug: /en/observability/apm-storage-guide
title: Storage and sizing guide
description: Description to be written
tags: []
---

<div id="apm-storage-guide"></div>

APM processing and storage costs are largely dominated by transactions, spans, and stack frames.

* <DocLink id="enObservabilityApmDataModelTransactions">**Transactions**</DocLink> describe an event captured by an Elastic ((apm-agent)) instrumenting a service.
    They are the highest level of work being measuring within a service.

* <DocLink id="enObservabilityApmDataModelSpans">**Spans**</DocLink> belong to transactions. They measure from the start to end of an activity,
...
<div id="typical_transactions"></div>
