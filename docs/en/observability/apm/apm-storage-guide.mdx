...
* <DocLink slug="/en/observability/apm-data-model-transactions">**Transactions**</DocLink> describe an event captured by an Elastic ((apm-agent)) instrumenting a service.
    They are the highest level of work being measuring within a service.

* <DocLink slug="/en/observability/apm-data-model-spans">**Spans**</DocLink> belong to transactions. They measure from the start to end of an activity,
