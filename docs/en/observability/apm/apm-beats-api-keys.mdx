---
id: enObservabilityApmBeatsApiKeys
...
See <DocLink id="enObservabilityApmSecureCommsStack" section="feature-roles">Feature roles</DocLink> for additional privileges and information.
</DocCallOut>
...
[^2]: Granted privileges, see <DocLink id="enObservabilityApmSecureCommsStack" section="feature-roles">Feature roles</DocLink>
