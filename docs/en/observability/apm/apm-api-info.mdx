---
slug: /en/observability/apm-api-info
title: APM Server information API
description: Description to be written
tags: []
---

<div id="apm-api-info"></div>
...
<div id="apm-api-info-endpoint"></div>
...
the instructions at <DocLink slug="/en/observability/apm-api-key">APM API key</DocLink> or <DocLink slug="/en/observability/apm-secret-token">APM Secret Token</DocLink>,
must be followed to configure the correct permissions for APM access.

If an <DocLink slug="/en/observability/apm-api-key">API keys</DocLink> or a <DocLink slug="/en/observability/apm-secret-token">Secret token</DocLink> is passed along with
...
<div id="apm-api-info-example-get-without-credentials"></div>
...
<div id="apm-api-info-example-post-with-secret-token"></div>

### Example: POST, with secret token

Example APM Server information request with POST, with a <DocLink slug="/en/observability/apm-secret-token">Secret token</DocLink>:
