...
<div id="indices_are_now_manged_by_((fleet))"></div>
...
<div id="data_streams_by_default"></div>
...
<div id="new_source_map_upload_endpoint"></div>
...
<div id="legacy_jaeger_endpoints_have_been_removed"></div>
...
<div id="supported_((ecloud))_settings"></div>
