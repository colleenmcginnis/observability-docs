---
id: enObservabilityApmSourceMapHowTo
...
* <DocLink id="enObservabilityApmSourceMapHowTo" section="initialize-the-rum-agent">Initialize the RUM Agent</DocLink>
* <DocLink id="enObservabilityApmSourceMapHowTo" section="generate-a-source-map">Generate a source map</DocLink>
* <DocLink id="enObservabilityApmSourceMapHowTo" section="upload-the-source-map">Upload the source map</DocLink>
