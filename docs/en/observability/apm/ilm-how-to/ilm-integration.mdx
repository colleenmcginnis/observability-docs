...
<div id="apm-data-streams-custom-policy{append_legacy}"></div>
...
<div id="apm-data-streams-custom-one{append_legacy}"></div>
...
1. In this example, I only have one data stream because I'm only using the `default` namespace.
    ...
    ![Data streams info](images/data-stream-overview.png)

<div id="apm-data-streams-custom-two{append_legacy}"></div>
...
<div id="apm-data-streams-custom-three{append_legacy}"></div>
...
1. Continue to **Review** and ensure your request looks similar to the image below.
    ...
    ![Create component template](images/create-component-template.png)

<div id="apm-data-streams-custom-four{append_legacy}"></div>
...
<div id="apm-data-streams-custom-policy-namespace{append_legacy}"></div>
