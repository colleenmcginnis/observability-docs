...
For more custom APM ingest pipeline guides, see <DocLink slug="/en/observability/apm-ingest-pipelines">parse data using ingest pipelines</DocLink>.
...
* Data streams define not only how data is stored in ((es)), but also how data is retained over time.
    See <DocLink slug="/en/observability/apm-ilm-how-to">((ilm-cap))</DocLink> to learn how to create your own data retention policies.

* See <DocLink slug="/en/observability/apm-manage-storage">Manage storage</DocLink> for information on APM storage and processing costs,
