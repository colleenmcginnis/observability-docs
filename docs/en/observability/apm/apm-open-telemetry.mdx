---
id: enObservabilityApmOpenTelemetry
...
<DocLink id="enObservabilityApmOpenTelemetryWithElastic">Get started</DocLink>.
...
<DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-agent">Get started</DocLink>.
...
<DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-collector">Get started</DocLink>.
...
<DocLink id="enObservabilityApmOpenTelemetryOtherEnv" section="apm-open-telemetry-aws-lambda">Get started</DocLink>.
