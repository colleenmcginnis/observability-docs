---
slug: /en/observability/apm-jaeger-integration
title: Jaeger integration
description: Description to be written
tags: []
---

import JaegerWidget from './tab-widgets/jaeger-widget.mdx'

<div id="apm-jaeger-integration"></div>
...
<div id="apm-jaeger-architecture"></div>
...
* The gRPC endpoint supports probabilistic sampling.
    Sampling decisions can be configured <DocLink slug="/en/observability/apm-jaeger-integration" section="((apm-agent))-central-configuration-default">centrally</DocLink> with ((apm-agent)) central configuration, or <DocLink slug="/en/observability/apm-jaeger-integration" section="local-sampling-in-each-jaeger-client">locally</DocLink> in each Jaeger client.

See the [Jaeger docs](https://www.jaegertracing.io/docs/1.27/architecture)
for more information on Jaeger architecture.

<div id="apm-get-started-jaeger"></div>

## Get started

Connect your preexisting Jaeger setup to Elastic APM in three steps:

* <DocLink slug="/en/observability/apm-jaeger-integration" section="configure-jaeger-agents">Configure Jaeger agents</DocLink>
* <DocLink slug="/en/observability/apm-jaeger-integration" section="configure-sampling">Configure Sampling</DocLink>
* <DocLink slug="/en/observability/apm-jaeger-integration" section="start-sending-data">Start sending data</DocLink>

<DocCallOut title="Important" color="warning">
There are <DocLink slug="/en/observability/apm-jaeger-integration" section="caveats">caveats</DocLink> to this integration.
</DocCallOut>

<div id="apm-configure-agent-client-jaeger"></div>
...
<div id="apm-configure-sampling-jaeger"></div>
...
* <DocLink slug="/en/observability/apm-jaeger-integration" section="((apm-agent))-central-configuration-default">((apm-agent)) central configuration (default)</DocLink>
* <DocLink slug="/en/observability/apm-jaeger-integration" section="local-sampling-in-each-jaeger-client">Local sampling in each Jaeger client</DocLink>

<div id="apm-configure-sampling-central-jaeger"></div>
...
<div id="apm-configure-sampling-local-jaeger"></div>
...
* Elastic APM's <DocLink slug="/en/observability/apm-data-model">Data Model</DocLink> is different than Jaegers.
    ...
    * Server Jaeger spans are mapped to Elastic APM <DocLink slug="/en/observability/apm-data-model-transactions">Transactions</DocLink>.
    * Client Jaeger spans are mapped to Elastic APM <DocLink slug="/en/observability/apm-data-model-spans">Spans</DocLink> -- unless the span is the root, in which case it is mapped to an Elastic APM <DocLink slug="/en/observability/apm-data-model-transactions">Transactions</DocLink>.
