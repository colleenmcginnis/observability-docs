---
id: enObservabilityApmTuneDataIngestion
...
* <DocLink id="enObservabilityApmTuneDataIngestion" section="add-apm-server-or-((agent))-instances">Add APM Server or ((agent)) instances</DocLink>
* <DocLink id="enObservabilityApmTuneDataIngestion" section="reduce-the-payload-size">Reduce the payload size</DocLink>
* <DocLink id="enObservabilityApmTuneDataIngestion" section="adjust-anonymous-auth-rate-limit">Adjust anonymous auth rate limit</DocLink>
...
Having several instances will also increase <DocLink id="enObservabilityApmHighAvailability">availability</DocLink>.
...
Optionally you can also <DocLink id="enObservabilityApmReduceApmStorage" section="reduce-the-sample-rate">reduce the sample rate</DocLink> or <DocLink id="enObservabilityApmReduceApmStorage" section="reduce-collected-stack-trace-information">reduce the amount of stack traces</DocLink>.
...
|  |  |
|---|---|
| APM Server binary | <DocLink id="enObservabilityApmConfigurationAnonymous" section="event-limit">`rate_limit.event_limit`</DocLink> |
