---
id: enObservabilityApmExploringEsData
...
* <DocLink id="enObservabilityApmExploringEsData" section="((es))-query-examples">((es)) query examples</DocLink>

<div id="apm-elasticsearch-query-examples"></div>

## ((es)) query examples

Elastic APM data is stored in <DocLink id="enObservabilityApmDataStreams">Data streams</DocLink>.
