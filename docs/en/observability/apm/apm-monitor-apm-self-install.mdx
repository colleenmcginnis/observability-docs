---
id: enObservabilityApmMonitorApmSelfInstall
...
1. <DocLink id="enObservabilityApmMonitorApmSelfInstall" section="configure-((agent))-to-send-monitoring-data">Configure ((agent)) to send monitoring data</DocLink>
1. <DocLink id="enObservabilityApmMonitorApmSelfInstall" section="install-and-configure-((metricbeat))-to-collect-monitoring-data">Install and configure ((metricbeat)) to collect monitoring data</DocLink>
