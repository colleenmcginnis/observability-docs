---
id: enObservabilityApmConfigurationSsl
...
* <DocLink id="enObservabilityApmConfigurationSsl" section="common-configuration-options">Common configuration options</DocLink>
* <DocLink id="enObservabilityApmConfigurationSsl" section="client-configuration-options">Client configuration options</DocLink>
* <DocLink id="enObservabilityApmConfigurationSsl" section="server-configuration-options">Server configuration options</DocLink>
...
When this option is configured, the <DocLink id="enObservabilityApmConfigurationSsl" section="key-etcpkiclientcertkey">`key`</DocLink> option is also required.
...
When this option is configured, the <DocLink id="enObservabilityApmConfigurationSsl" section="key-etcpkiservercertkey">`key`</DocLink> option is also required.
The certificate option support embedding of the certificate:
