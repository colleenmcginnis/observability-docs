---
id: enObservabilityApmDataModelMetrics
slug: /en/observability/apm-data-model-metrics
title: Metrics
...
<div id="apm-data-model-metrics"></div>
...
Most agents limit keyword fields to 1024 characters,
...
<div id="example_system_metric_document"></div>
...
<div id="example_breakdown_metric_document"></div>
...
<div id="transaction_metrics"></div>
...
<div id="service-transaction_metrics"></div>
...
<div id="example_service-transaction_document"></div>
...
<div id="service-destination_metrics"></div>
...
<div id="example_service-destination_document"></div>
...
<div id="service-summary_metrics"></div>
...
<div id="example_service-summary_document"></div>
...
<div id="aggregated_metrics:_limits_and_overflows"></div>
