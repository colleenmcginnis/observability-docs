...
The natural integration of <DocLink slug="/en/observability/apm-distributed-tracing">distributed tracing</DocLink> into your AWS Lambda functions provides insights into the function's execution and runtime behavior as well as its relationships and dependencies to other services.
