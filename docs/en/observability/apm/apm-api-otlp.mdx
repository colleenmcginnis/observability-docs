...
<DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-agent">OpenTelemetry agent</DocLink> or
<DocLink id="enObservabilityApmOpenTelemetryDirect" section="send-data-from-an-opentelemetry-collector">OpenTelemetry collector</DocLink>.
</DocCallOut>
