---
id: enObservabilityApmDistributedTracing
slug: /en/observability/apm-distributed-tracing
title: Distributed tracing
description: Description to be written
tags: []
---

import TabWidgetsDistributedTraceSendWidget from './tab-widgets/distributed-trace-send-widget.mdx'
import TabWidgetsDistributedTraceReceiveWidget from './tab-widgets/distributed-trace-receive-widget.mdx'

<div id="apm-distributed-tracing"></div>

A `trace` is a group of <DocLink id="enObservabilityApmDataModelTransactions">transactions</DocLink> and <DocLink id="enObservabilityApmDataModelSpans">spans</DocLink> with a common root.
...
<div id="apm-why-distributed-tracing"></div>
...
<div id="apm-how-distributed-tracing"></div>
...
<div id="apm-trace-propagation"></div>
...
![How traceparent propagation works](images/dt-trace-ex1.png)

In this example, Elastic's Ruby agent communicates with OpenTelemetry's Java agent.
Both support the `traceparent` header, and trace data is successfully propagated.

{/* lint ignore traceparent */}
![How traceparent propagation works](images/dt-trace-ex2.png)
...
{/* lint ignore traceparent */}
![How traceparent propagation works](images/dt-trace-ex3.png)

<div id="apm-w3c-tracecontext-spec"></div>
...
<div id="apm-visualize-distributed-tracing"></div>
...
![Distributed tracing in the APM UI](images/apm-distributed-tracing.png)

<div id="apm-manual-distributed-tracing"></div>
...
<div id="apm-distributed-tracing-outgoing"></div>
...
<div id="apm-distributed-tracing-incoming"></div>
...
<div id="apm-distributed-tracing-rum"></div>
