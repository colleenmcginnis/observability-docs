---
slug: /en/observability/apm-reduce-apm-storage
title: Reduce storage
description: Description to be written
tags: []
---

<div id="apm-reduce-apm-storage"></div>
...
<div id="apm-reduce-sample-rate"></div>
...
See <DocLink slug="/en/observability/apm-sampling">Transaction sampling</DocLink> to learn more.

<div id="enable_span_compression"></div>
...
See <DocLink slug="/en/observability/apm-span-compression">Span compression</DocLink> to learn more.

<div id="apm-reduce-stacktrace"></div>
...
* periodically with <DocLink slug="/en/observability/apm-reduce-apm-storage" section="delete-data-with-((ilm))-((ilm-init))">((ilm))</DocLink>
* <DocLink slug="/en/observability/apm-reduce-apm-storage" section="delete-data-matching-a-query">matching a query</DocLink>
* with the <DocLink slug="/en/observability/apm-reduce-apm-storage" section="delete-data-with-((kib))-index-management">((kib)) Index Management UI</DocLink>

If you want to delete data for security or privacy reasons, see <DocLink slug="/en/observability/apm-data-security">Data security</DocLink>.

<div id="apm-delete-data-with-ilm"></div>
...
See <DocLink slug="/en/observability/apm-ilm-how-to">((ilm-cap))</DocLink> to learn more.

<div id="apm-delete-data-query"></div>
...
<div id="apm-delete-data-in-kibana"></div>
