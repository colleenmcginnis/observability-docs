---
id: enObservabilityApmApiMetadata
...
* <DocLink id="enObservabilityApmApiMetadata" section="kubernetes-data">Kubernetes data</DocLink>
* <DocLink id="enObservabilityApmApiMetadata" section="metadata-schema">Metadata Schema</DocLink>
