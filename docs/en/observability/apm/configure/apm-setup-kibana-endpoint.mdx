...
<ApmSupportOverview binary={true} fleet={false}>
  ...
  Please see <DocLink slug="/en/observability/apm-configure-agent-config">Configure APM agent configuration</DocLink> instead.
</ApmSupportOverview>
...
from the <DocLink slug="/en/observability/apm-setup-kibana-endpoint" section="apm-serverkibanaprotocol">apm-server.kibana.protocol</DocLink> and
<DocLink slug="/en/observability/apm-setup-kibana-endpoint" section="apm-serverkibanapath">apm-server.kibana.path</DocLink> config options.
</DocCallOut>
...
see <DocLink slug="/en/observability/apm-configuration-ssl">SSL/TLS output settings</DocLink>.
