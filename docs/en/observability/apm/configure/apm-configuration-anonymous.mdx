...
<DocLink slug="/en/observability/apm-secure-agent-communication">authenticated communication</DocLink> is disabled.
</DocCallOut>
...
For this reason, anonymous auth will be enabled automatically if <DocLink slug="/en/observability/apm-configuration-rum" section="enable-rum">Enable RUM</DocLink>
is set to `true`, and <DocLink slug="/en/observability/apm-configuration-anonymous" section="anonymous-agent-access">Anonymous Agent access</DocLink> is not explicitly defined.

See <DocLink slug="/en/observability/apm-configuration-rum">Configure Real User Monitoring (RUM)</DocLink> for additional RUM configuration options.
...
Use the <DocLink slug="/en/observability/apm-configuration-anonymous" section="allowed-anonymous-agents">Allowed anonymous agents</DocLink> and <DocLink slug="/en/observability/apm-configuration-anonymous" section="allowed-services">Allowed services</DocLink> configs to ensure that the
...
(`client.ip`) of the request with <DocLink slug="/en/observability/apm-configuration-anonymous" section="event-limit">Event limit</DocLink>.
