---
id: enObservabilityApmKafkaOutput
...
Events bigger than <DocLink id="enObservabilityApmKafkaOutput" section="max_message_bytes">`max_message_bytes`</DocLink> will be dropped. To avoid this problem, make sure APM Server does not generate events bigger than <DocLink id="enObservabilityApmKafkaOutput" section="max_message_bytes">`max_message_bytes`</DocLink>.
</DocCallOut>
...
See <DocLink id="enObservabilityApmKafkaOutput" section="compatibility">Compatibility</DocLink> for information on supported versions.
...
See the <DocLink id="enObservabilityApmKafkaOutput" section="topics">`topics`</DocLink> setting for other ways to set the
topic dynamically.
...
<DocLink id="enObservabilityApmKafkaOutput" section="topic">`topic`</DocLink> field is used.
...
See <DocLink id="enObservabilityApmConfigurationSsl">SSL/TLS output settings</DocLink> for more information.
