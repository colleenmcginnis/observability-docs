---
slug: /en/observability/apm-kafka-output
title: Configure the Kafka output
...
Events bigger than <DocLink slug="/en/observability/apm-kafka-output" section="max_message_bytes">`max_message_bytes`</DocLink> will be dropped. To avoid this problem, make sure APM Server does not generate events bigger than <DocLink slug="/en/observability/apm-kafka-output" section="max_message_bytes">`max_message_bytes`</DocLink>.
</DocCallOut>
...
<div id="apm-kafka-compatibility"></div>
...
See <DocLink slug="/en/observability/apm-kafka-output" section="compatibility">Compatibility</DocLink> for information on supported versions.
...
<div id="apm-topic-option-kafka"></div>
...
See the <DocLink slug="/en/observability/apm-kafka-output" section="topics">`topics`</DocLink> setting for other ways to set the
topic dynamically.

<div id="apm-topics-option-kafka"></div>
...
<DocLink slug="/en/observability/apm-kafka-output" section="topic">`topic`</DocLink> field is used.
...
<div id="`bulk_flush_frequency`"></div>
...
<div id="apm-kafka-max_message_bytes"></div>
...
See <DocLink slug="/en/observability/apm-configuration-ssl">SSL/TLS output settings</DocLink> for more information.
