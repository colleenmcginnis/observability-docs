---
id: enObservabilityApmLogstashOutput
...
1. <DocLink id="enObservabilityApmLogstashOutput" section="((ls))-output-configuration">Enable the ((ls)) output in APM Server</DocLink>
1. <DocLink id="enObservabilityApmLogstashOutput" section="((kib))-endpoint-configuration">Enable the ((kib)) endpoint in APM Server</DocLink>
1. <DocLink id="enObservabilityApmLogstashOutput" section="((ls))-configuration-pipeline">Create a ((ls)) configuration pipeline in ((ls))</DocLink>
...
<DocLink id="enObservabilityApmLogstashOutput" section="index">`index`</DocLink> option in the APM Server config file.
...
<DocLink id="enObservabilityApmLogstashOutput" section="proxy_use_local_resolver">`proxy_use_local_resolver`</DocLink> option.
...
<DocLink id="enObservabilityApmConfigurationSsl">SSL/TLS output settings</DocLink> for more information. To use SSL, you must also configure the
