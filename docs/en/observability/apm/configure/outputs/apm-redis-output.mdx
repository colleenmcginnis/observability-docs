...
See the <DocLink slug="/en/observability/apm-redis-output" section="keys">`keys`</DocLink> setting for other ways to set the key
dynamically.
...
<DocLink slug="/en/observability/apm-redis-output" section="key">`key`</DocLink> setting is used.
...
<DocLink slug="/en/observability/apm-configuration-ssl">SSL/TLS output settings</DocLink> for more information.
...
<DocLink slug="/en/observability/apm-redis-output" section="proxy_use_local_resolver">`proxy_use_local_resolver`</DocLink> option.
