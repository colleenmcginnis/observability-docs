---
id: enObservabilityApmConfigureAgentConfig
...
Takes the same options as <DocLink id="enObservabilityApmElasticsearchOutput">output.elasticsearch</DocLink>.
...
To fix this error, ensure that APM Server has all the required privileges. See <DocLink id="enObservabilityApmPrivilegesAgentCentralConfig" section="apm-server-agent-central-configuration-management">APM Server agent central configuration management</DocLink> for more details.
