...
<ApmSupportOverview binary={true} fleet={false}>
  ...
  Fleet-managed paths are defined in <DocLink slug="/en/observability/apm-directory-layout">Installation layout</DocLink>.
</ApmSupportOverview>
...
Please see the <DocLink slug="/en/observability/apm-directory-layout">Installation layout</DocLink> section for more details.
