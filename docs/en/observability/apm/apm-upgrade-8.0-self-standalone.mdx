---
id: enObservabilityApmUpgrade8.0SelfStandalone
...
1. **Install the ((version)) APM Server release**
    ...
    See <DocLink id="enObservabilityApmInstalling">install</DocLink> to find the command that works with your system.
...
1. **Review your configuration file**
    ...
    See <DocLink id="enObservabilityApmDirectoryLayout">Installation layout</DocLink> for help in locating this file,
    and <DocLink id="enObservabilityApmConfiguringHowtoApmServer">Configure</DocLink> for a list of all available configuration options.
...
1. **Start the APM Server**
    ...
    Additional details are available in <DocLink id="enObservabilityApmServerStarting">start the APM Server</DocLink>.
