...
make sure <DocLink id="enObservabilityApmAgentTls">TLS</DocLink> is enabled, then complete these steps:

1. <DocLink id="enObservabilityApmApiKey" section="enable-api-keys">Enable API keys</DocLink>
1. <DocLink id="enObservabilityApmApiKey" section="create-an-api-key-user-in-((kib))">Create an API key user</DocLink>
1. <DocLink id="enObservabilityApmApiKey" section="create-an-api-key-in-the-((apm-app))">Create an API key in ((kib))</DocLink>
1. <DocLink id="enObservabilityApmApiKey" section="set-the-api-key-in-your-apm-agents">Set the API key in your APM agents</DocLink>
...
* <DocLink id="enObservabilityApmApiKey" section="apm-server-api-key-workflow">APM Server API key workflow</DocLink>
* <DocLink id="enObservabilityApmApiKey" section="((es))-api-key-workflow">((es)) API key workflow</DocLink>
...
A full list of `apikey` subcommands and flags is available in the <DocLink id="enObservabilityApmCommandLineOptions" section="apikey-command">API key command reference</DocLink>.
