...
* <DocLink slug="/en/observability/apm-sampling" section="head-based-sampling">Head-based sampling</DocLink>
* <DocLink slug="/en/observability/apm-sampling" section="tail-based-sampling">Tail-based sampling</DocLink>
...
See <DocLink slug="/en/observability/apm-configure-head-based-sampling">Configure head-based sampling</DocLink> to get started.
...
See <DocLink slug="/en/observability/apm-configure-tail-based-sampling">Configure tail-based sampling</DocLink> to get started.
...
A non-sampled trace drops all <DocLink slug="/en/observability/apm-data-model-spans">span</DocLink> and <DocLink slug="/en/observability/apm-data-model-transactions">transaction</DocLink> data<sup>1</sup>.
Regardless of the sampling decision, all traces retain <DocLink slug="/en/observability/apm-data-model-errors">error</DocLink> data.

Some visualizations in the ((apm-app)), like latency, are powered by aggregated transaction and span <DocLink slug="/en/observability/apm-data-model-metrics">metrics</DocLink>.
