---
id: enObservabilityApmDataModelSpans
slug: /en/observability/apm-data-model-spans
title: Spans
...
<div id="apm-data-model-spans"></div>
...
* A `transaction.id` attribute that refers to its parent <DocLink id="enObservabilityApmDataModelTransactions">transaction</DocLink>.
...
<div id="apm-data-model-dropped-spans"></div>
...
* PHP: [`transaction_max_spans`](((apm-php-ref-v))/configuration-reference.html#config-transaction-max-spans)
...
<div id="apm-data-model-missing-spans"></div>
...
<div id="example_span_document"></div>
