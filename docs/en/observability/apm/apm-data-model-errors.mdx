---
id: enObservabilityApmDataModelErrors
...
* An error might relate to the <DocLink id="enObservabilityApmDataModelTransactions">transaction</DocLink> during which it happened,
...
* Data about the environment in which the event is recorded:
    ...
    * <DocLink id="enObservabilityApmDataModelMetadata" section="user-context">User</DocLink> - (if supplied) email, ID, username, etc.

In addition, agents provide options for users to capture custom <DocLink id="enObservabilityApmDataModelMetadata">metadata</DocLink>.
Metadata can be indexed - <DocLink id="enObservabilityApmDataModelMetadata" section="labels">`labels`</DocLink>, or not-indexed - <DocLink id="enObservabilityApmDataModelMetadata" section="custom-context">`custom`</DocLink>.
...
See <DocLink id="enObservabilityApmDataStreams">Data streams</DocLink> to learn more.
