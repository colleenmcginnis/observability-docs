...
* <DocLink slug="/en/observability/apm-custom-filter" section="create-an-ingest-pipeline-filter">Create an ingest pipeline filter</DocLink> — Learn how to obfuscate passwords stored in the `http.request.body.original` field.
* <DocLink slug="/en/observability/apm-data-streams" section="apm-data-stream-rerouting">APM data stream rerouting</DocLink> — Learn how rerouting APM data to user-defined APM data streams.
