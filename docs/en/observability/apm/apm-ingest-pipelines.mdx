---
id: enObservabilityApmIngestPipelines
slug: /en/observability/apm-ingest-pipelines
...
<div id="apm-ingest-pipelines"></div>
...
* <DocLink id="enObservabilityApmCustomFilter" section="create-an-ingest-pipeline-filter">Create an ingest pipeline filter</DocLink> — Learn how to obfuscate passwords stored in the `http.request.body.original` field.
* <DocLink id="enObservabilityApmDataStreams" section="apm-data-stream-rerouting">APM data stream rerouting</DocLink> — Learn how rerouting APM data to user-defined APM data streams.
