...
* To use token-based **API key authentication**, specify the `api_key` under `output.elasticsearch`.
    ...
    To create an API key like this, see <DocLink id="enObservabilityApmBeatsApiKeys">Grant access using API keys</DocLink>.
...
If you've configured the <DocLink id="enObservabilityApmSetupKibanaEndpoint">((kib)) endpoint</DocLink>,
...
* <DocLink id="enObservabilityApmConfigurationSsl">SSL/TLS output settings</DocLink>
