---
id: enObservabilityApmFiltering
slug: /en/observability/apm-filtering
title: Built-in data filters
...
<div id="apm-filtering"></div>

<DataFilters />

<div id="apm-filters-http-header"></div>
...
<div id="apm-filters-http-body"></div>
...
<div id="apm-filters-personal-data"></div>
...
* `client.ip`: The client's IP address. Typically derived from the HTTP headers of incoming requests.
    ...
    see <DocLink id="enObservabilityApmAnonymousAuth" section="deriving-an-incoming-requests-clientip-address">Deriving an incoming request's `client.ip` address</DocLink>.
...
<div id="apm-filters-real-user-data"></div>
...
<div id="apm-filters-database-statements"></div>
...
<div id="apm-filters-agent-specific"></div>
