...
Say you decide to <DocLink slug="/en/observability/apm-filtering" section="http-bodies">capture HTTP request bodies</DocLink>
...
To learn more about ingest pipelines, see <DocLink slug="/en/observability/apm-custom-index-template" section="view-the-((es))-index-template">View the ((es)) index template</DocLink>.
