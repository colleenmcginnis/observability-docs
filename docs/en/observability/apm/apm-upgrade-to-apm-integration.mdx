---
id: enObservabilityApmUpgradeToApmIntegration
...
* <DocLink id="enObservabilityApmIntegrationUpgradeSteps">Switch a self-installation to the APM integration</DocLink>
* <DocLink id="enObservabilityApmIntegrationUpgradeStepsEss">Switch an ((ecloud)) cluster to the APM integration</DocLink>
