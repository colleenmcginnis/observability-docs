...
1. <DocLink slug="/en/observability/apm-monitoring-metricbeat-collection" section="configure-the-shipper-you-want-to-monitor">Configure the shipper you want to monitor</DocLink>

1. <DocLink slug="/en/observability/apm-monitoring-metricbeat-collection" section="install-and-configure-((metricbeat))-to-collect-monitoring-data">Install and configure ((metricbeat)) to collect monitoring data</DocLink>
...
1. Identify where to send the monitoring data.
    ...
    information, see <DocLink slug="/en/observability/apm-secure-comms-stack" section="feature-roles">Feature roles</DocLink>.
    </DocCallOut>
