---
id: enObservabilityApmMonitoring
...
* <DocLink id="enObservabilityApmMonitoringInternalCollection">Internal collection</DocLink> - Internal
...
* <DocLink id="enObservabilityApmMonitoringMetricbeatCollection">((metricbeat)) collection</DocLink> -
    ((metricbeat)) collects monitoring data from your APM Server instance
    and sends it directly to your monitoring cluster.

* <DocLink id="enObservabilityApmMonitoringLocalCollection">Local collection</DocLink> - Local collection sends
