...
The default is `50`. For more information, see <DocLink id="enObservabilityApmElasticsearchOutput">Configure the ((es)) output</DocLink>.
...
<DocLink id="enObservabilityApmElasticsearchOutput">Configure the ((es)) output</DocLink>.
...
default value is `3`. For more information, see <DocLink id="enObservabilityApmElasticsearchOutput">Configure the ((es)) output</DocLink>.
...
information, see <DocLink id="enObservabilityApmElasticsearchOutput">Configure the ((es)) output</DocLink>.
...
HTTPS connections to ((es)). For more information, see <DocLink id="enObservabilityApmConfigurationSsl">SSL/TLS output settings</DocLink>.
