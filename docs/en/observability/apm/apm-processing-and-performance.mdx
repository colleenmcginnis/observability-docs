---
id: enObservabilityApmProcessingAndPerformance
...
* In all scenarios, using medium sized events. Events include
    <DocLink id="enObservabilityApmDataModelTransactions">transactions</DocLink> and
...
decreasing the ingestion volume. Read more in <DocLink id="enObservabilityApmReduceApmStorage">Reduce storage</DocLink>.
