---
id: enObservabilityApmInstalling
...
If you use `apt` or `yum`, you can <DocLink id="enObservabilityApmSetupRepositories">install APM Server from our repositories</DocLink>
...
See <DocLink id="enObservabilityApmRunningOnDocker">Running on Docker</DocLink> for deploying Docker containers.
