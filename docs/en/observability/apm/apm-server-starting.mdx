---
id: enObservabilityApmServerStarting
...
The `-e` <DocLink id="enObservabilityApmCommandLineOptions" section="global-flags">global flag</DocLink> enables logging to stderr and disables syslog/file output.
Remove this flag if you've enabled logging in the configuration file.
For Linux systems, see <DocLink id="enObservabilityApmRunningWithSystemd">APM Server status and logs</DocLink>.
</DocCallOut>
...
See the <DocLink id="enObservabilityApmDirectoryLayout">deb & rpm default paths</DocLink> for a full directory layout.
