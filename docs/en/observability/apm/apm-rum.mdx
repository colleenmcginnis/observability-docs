---
id: enObservabilityApmRum
slug: /en/observability/apm-rum
...
The [JavaScript Agent](((apm-rum-ref-v))) is Elastic’s RUM Agent.
{/* To use it you need to [enable RUM support](((apm-server-ref-v))/configuration-rum.html) in the APM Server. */}
