...
See <DocLink slug="/en/observability/traces-get-started">getting started documentation</DocLink> to get started in minutes.
</DocCallOut>
...
* **<DocLink slug="/en/observability/apm-getting-started-apm-server" section="apm-server-binary">APM Server binary</DocLink>**
* **<DocLink slug="/en/observability/apm-getting-started-apm-server" section="fleet-managed-apm-server">Fleet-managed APM Server</DocLink>**
