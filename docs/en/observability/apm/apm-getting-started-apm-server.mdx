---
id: enObservabilityApmGettingStartedApmServer
slug: /en/observability/apm-getting-started-apm-server
title: Self manage APM Server
description: Description to be written
tags: []
---

<div id="apm-getting-started-apm-server"></div>

<DocCallOut title="Tip">
The easiest way to get started with Elastic APM is by using our
[hosted ((es)) Service](((ess-product))) on ((ecloud)).
The ((es)) Service is available on AWS, GCP, and Azure.
See <DocLink id="enObservabilityTracesGetStarted">getting started documentation</DocLink> to get started in minutes.
</DocCallOut>
...
* **<DocLink id="enObservabilityApmGettingStartedApmServer" section="apm-server-binary">APM Server binary</DocLink>**
* **<DocLink id="enObservabilityApmGettingStartedApmServer" section="fleet-managed-apm-server">Fleet-managed APM Server</DocLink>**
{/* * **\<\<setup-apm-server-ea,Standalone Elastic Agent-managed APM Server>>** */}

<div id="apm-setup-apm-server-binary"></div>

## APM Server binary

Install, configure, and run the APM Server binary wherever you need it.

![APM Server binary overview](images/bin-ov.png)
...
<div id="apm-setup-fleet-managed-apm"></div>
...
![APM Server fleet overview](images/fm-ov.png)
...
{/* [float] */}
{/* <span id="apm-setup-apm-server-ea"></span>  */}
...
{/* <DocImage flatImage alt="APM Server ea overview" url="undefined" /> */}
