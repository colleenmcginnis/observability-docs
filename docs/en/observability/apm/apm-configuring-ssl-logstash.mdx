...
* `certificate` and `key`: Specifies the certificate and key that APM Server uses to authenticate with
    ...
    For more information about these configuration options, see <DocLink id="enObservabilityApmConfigurationSsl">SSL/TLS output settings</DocLink>.
...
See the <DocLink id="enObservabilityApmCommonProblems" section="ssl-client-fails-to-connect">troubleshooting docs</DocLink> for info about resolving this issue.
...
Any errors will be printed to the console. See the <DocLink id="enObservabilityApmCommonProblems" section="ssl-client-fails-to-connect">troubleshooting docs</DocLink> for info about
