---
slug: /en/observability/apm-api-events
title: Elastic APM events intake API
description: Description to be written
tags: []
---

<div id="apm-api-events"></div>
...
See the <DocLink slug="/en/observability/apm-data-model">APM data model</DocLink> to learn more about the different types of events.

<div id="apm-api-events-endpoint"></div>
...
<div id="apm-api-events-example"></div>
...
For <DocLink slug="/en/observability/apm-rum">RUM</DocLink> send an `HTTP POST` request to the APM Server `intake/v3/rum/events` endpoint instead:

```bash
http(s)://{hostname}:{port}/intake/v3/rum/events
```

<div id="apm-api-events-response"></div>
...
<div id="apm-api-events-errors"></div>
...
<div id="apm-api-events-schema-definition"></div>

## Event API Schemas

The APM Server uses a collection of JSON Schemas for validating requests to the intake API:

* <DocLink slug="/en/observability/apm-api-metadata">Metadata</DocLink>
* <DocLink slug="/en/observability/apm-api-transaction">Transactions</DocLink>
* <DocLink slug="/en/observability/apm-api-span">Spans</DocLink>
* <DocLink slug="/en/observability/apm-api-error">Errors</DocLink>
* <DocLink slug="/en/observability/apm-api-metricset">Metrics</DocLink>
* <DocLink slug="/en/observability/apm-api-event-example">Example request body</DocLink>
