...
1. <DocLink slug="/en/observability/apm-integration-upgrade-steps" section="upgrade-the-((stack))">Upgrade the ((stack))</DocLink>
1. <DocLink slug="/en/observability/apm-integration-upgrade-steps" section="add-a-((fleet))-server">Add a ((fleet)) Server</DocLink>
1. <DocLink slug="/en/observability/apm-integration-upgrade-steps" section="install-a-((fleet))-managed-((agent))">Install a ((fleet))-managed ((agent))</DocLink>
1. <DocLink slug="/en/observability/apm-integration-upgrade-steps" section="add-the-apm-integration">Add the APM integration</DocLink>
1. <DocLink slug="/en/observability/apm-integration-upgrade-steps" section="stop-the-apm-server">Stop the APM Server</DocLink>
...
Review the APM <DocLink slug="/en/observability/apm-release-notes">release notes</DocLink>, <DocLink slug="/en/observability/apm-breaking">breaking changes</DocLink>,
...
To add the APM integration, see <DocLink slug="/en/observability/traces-get-started" section="step-1-configure-the-apm-integration">Step 1: Configure the APM integration</DocLink>.
