...
* **General read access**: For most users, you can use <DocLink slug="/en/observability/synthetics-role-read" section="general-read-access">General read access</DocLink>,
...
* **Limited read access**: If you want to limit read access to the ((synthetics-app)) only,
    you can use <DocLink slug="/en/observability/synthetics-role-read" section="limited-read-access">Limited read access</DocLink>, which requires additional configuration.
