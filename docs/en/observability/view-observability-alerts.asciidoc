...
* From the Alerts table, use the {eui-icon-boxesHorizontal} and click *View rule details*.

To view the alert in the app that triggered it:

* From the alert detail flyout, click *View in app*.
* From the Alerts table, click the {eui-icon-eye}.
...
From the Alerts table, you can add one or more alerts to a case. Click the {eui-icon-boxesHorizontal} icon
