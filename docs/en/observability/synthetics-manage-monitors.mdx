...
After you've <DocLink slug="/en/observability/synthetics-get-started">created a synthetic monitor</DocLink>,
...
<DocLink slug="/en/observability/synthetics-manage-monitors" section="implement-best-practices-for-projects">best practices for managing monitors effectively</DocLink>
...
After you've <DocLink slug="/en/observability/synthetics-get-started-project">set up a project</DocLink>,
