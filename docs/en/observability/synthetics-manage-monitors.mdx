---
id: enObservabilitySyntheticsManageMonitors
slug: /en/observability/synthetics-manage-monitors
title: Manage monitors
description: Description to be written
tags: []
---

import SyntheticsManageMonitorsUpdateMonitorWidget from './tab-widgets/synthetics/manage-monitors-update-monitor-widget.mdx'
import SyntheticsManageMonitorsDeleteMonitorWidget from './tab-widgets/synthetics/manage-monitors-delete-monitor-widget.mdx'

<div id="synthetics-manage-monitors"></div>

After you've <DocLink id="enObservabilitySyntheticsGetStarted">created a synthetic monitor</DocLink>,
...
<DocLink id="enObservabilitySyntheticsManageMonitors" section="implement-best-practices-for-projects">best practices for managing monitors effectively</DocLink>
...
After you've <DocLink id="enObservabilitySyntheticsGetStartedProject">set up a project</DocLink>,
