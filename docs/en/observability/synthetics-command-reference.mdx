...
<DocDefList>
  ...
  <DocDefDescription>
    ...
    <DocLink slug="/en/observability/synthetics-configuration" section="params">`synthetics.config.js` file</DocLink>.
  ...
  <DocDefDescription>
    ...
    <DocLink slug="/en/observability/synthetics-configuration" section="playwrightoptions">the configuration docs</DocLink>.

    Options passed will be merged with Playwright options defined in your
    <DocLink slug="/en/observability/synthetics-configuration" section="playwrightoptions">`synthetics.config.js` file</DocLink>.
  ...
  <DocDefDescription>
    ...
    <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.screenshot`</DocLink>.
  ...
  <DocDefDescription>
    ...
    ((kib)). Allowed options are described in the <DocLink slug="/en/observability/synthetics-configuration" section="synthetics-config-file">configuration file</DocLink>.
  </DocDefDescription>
  ...
  <DocDefDescription>
    ...
    <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.throttling`</DocLink>.
    The value defined via the CLI will take precedence.
...
Read more about what's included in a template project in <DocLink slug="/en/observability/synthetics-get-started-project" section="create-a-project">Create a project</DocLink>.
...
<DocDefList>
  ...
  <DocDefDescription>
    ...
    If you are pushing to a <DocLink slug="/en/observability/synthetics-get-started-ui" section="private-locations">((private-location))</DocLink>, you must use an API key generated in 8.4 or higher.
  ...
  <DocDefDescription>
    ...
    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="project">`project.id`</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
  ...
  <DocDefDescription>
    ...
    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="project">`project.url`</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
  ...
  <DocDefDescription>
    ...
    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="project">`project.space`</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
  ...
  <DocDefDescription>
    ...
    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.schedule`</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
  ...
  <DocDefDescription>
    ...
    To list available locations, refer to <DocLink slug="/en/observability/synthetics-command-reference" section="elasticsynthetics-locations">`@elastic/synthetics locations`</DocLink>.

    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.locations` in the configuration file</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
  ...
  <DocDefDescription>
    The <DocLink slug="/en/observability/synthetics-private-location">((private-location))s</DocLink> to which the monitors will be deployed. These ((private-location))s refer to locations hosted and managed by you, whereas
    `locations` are hosted by Elastic. You can specify a ((private-location)) using the location's name.

    To list available ((private-location))s, refer to <DocLink slug="/en/observability/synthetics-command-reference" section="elasticsynthetics-locations">`@elastic/synthetics locations`</DocLink>.

    This can also be set in the configuration file using
    <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.privateLocations` in the configuration file</DocLink>.
    The value defined via the CLI will take precedence.
  </DocDefDescription>
...
To apply tags to all browser and lightweight monitors, configure using <DocLink slug="/en/observability/synthetics-configuration" section="monitor">`monitor.tags`</DocLink> field in the `synthetics.config.ts` file.
...
<DocLink slug="/en/observability/synthetics-troubleshooting" section="you-do-not-have-permission-to-use-elastic-managed-locations">troubleshooting docs</DocLink>.
</DocCallOut>
