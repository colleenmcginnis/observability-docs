...
For more information about security-sensitive use cases, refer to the <DocLink slug="/en/observability/synthetics-params-secrets" section="working-with-secrets-and-sensitive-values">documentation about sensitive values</DocLink>.
...
* In the _Global parameters_ tab of the <DocLink slug="/en/observability/synthetics-settings" section="global-parameters">Synthetics Settings page in ((kib))</DocLink>.
* Declaring a default value for the parameter in a <DocLink slug="/en/observability/synthetics-params-secrets" section="project-config-file">configuration file</DocLink>.
* Passing the `--params` <DocLink slug="/en/observability/synthetics-params-secrets" section="cli-argument">CLI argument</DocLink>.

<DocCallOut title="Note">
If you are creating and managing synthetic monitors using
<DocLink slug="/en/observability/synthetics-get-started-project">projects</DocLink>, you can also use regular environment
...
To set parameters when running <DocLink slug="/en/observability/synthetics-command-reference">`npx @elastic/synthetics` on the command line</DocLink>,
