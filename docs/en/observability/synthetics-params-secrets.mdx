---
id: enObservabilitySyntheticsParamsSecrets
slug: /en/observability/synthetics-params-secrets
...
For more information about security-sensitive use cases, refer to the <DocLink id="enObservabilitySyntheticsParamsSecrets" section="working-with-secrets-and-sensitive-values">documentation about sensitive values</DocLink>.
...
* In the _Global parameters_ tab of the <DocLink id="enObservabilitySyntheticsSettings" section="global-parameters">Synthetics Settings page in ((kib))</DocLink>.
* Declaring a default value for the parameter in a <DocLink id="enObservabilitySyntheticsParamsSecrets" section="project-config-file">configuration file</DocLink>.
* Passing the `--params` <DocLink id="enObservabilitySyntheticsParamsSecrets" section="cli-argument">CLI argument</DocLink>.

<DocCallOut title="Note">
If you are creating and managing synthetic monitors using
<DocLink id="enObservabilitySyntheticsGetStartedProject">projects</DocLink>, you can also use regular environment
...
1. **Global parameters in ((kib))**: The _Global parameters_ set in ((kib)) are read first.
...
<div id="synthetics-params-secrets-kibana"></div>
...
![Global parameters tab on the Synthetics Settings page in ((kib))](images/synthetics-params-secrets-kibana-define.png)
...
To set parameters when running <DocLink id="enObservabilitySyntheticsCommandReference">`npx @elastic/synthetics` on the command line</DocLink>,
...
<div id="synthetics-params-secrets-use-project"></div>
