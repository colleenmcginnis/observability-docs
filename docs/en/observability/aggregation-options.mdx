...
| Rate | Rate at which a specific field changes over time. To learn about how the rate is calculated, refer to <DocLink slug="/en/observability/rate-aggregation">Rate aggregation</DocLink>. |
