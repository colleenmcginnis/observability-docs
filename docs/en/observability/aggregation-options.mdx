---
id: enObservabilityAggregationOptions
slug: /en/observability/aggregation-options
title: Aggregation options
description: Description to be written
tags: []
---

<div id="aggregation-options"></div>
...
| Rate | Rate at which a specific field changes over time. To learn about how the rate is calculated, refer to <DocLink id="enObservabilityRateAggregation">Rate aggregation</DocLink>. |
