---
id: enObservabilityInspectUptimeDurationAnomalies
...
[((ml-app)) app](((ml-docs))/ml-gs-results.html), enable an <DocLink id="enObservabilityDurationAnomalyAlert">anomaly rule</DocLink>,
or disable the ((anomaly-detect)).

</DocCallOut>

1. You are prompted to create a <DocLink id="enObservabilityDurationAnomalyAlert">response duration anomaly rule</DocLink> for the ((ml)) job which will carry
