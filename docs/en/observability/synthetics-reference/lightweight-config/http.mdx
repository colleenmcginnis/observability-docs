...
<DocTable columns={[
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-http-max_redirects">
        **`max_redirects`**
      </span>
      (<DocLink slug="/en/observability/synthetics-lightweight" section="number">number</DocLink>)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-http-proxy_headers">
        **`proxy_headers`**
      </span>
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-http-proxy_url">
        **`proxy_url`**
      </span>
      (<DocLink slug="/en/observability/synthetics-lightweight" section="string">string</DocLink>)
    </DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      <DocDefList>
        ...
        <DocDefTerm>
          **`include_body_max_bytes`** (<DocLink slug="/en/observability/synthetics-lightweight" section="number">number</DocLink>)
        </DocDefTerm>
        <DocDefDescription>
      ...
      <DocDefList>
        ...
        <DocDefDescription>
          ...
          <DocDefList>
            ...
            <DocDefTerm>
              **`body`** (<DocLink slug="/en/observability/synthetics-lightweight" section="string">string</DocLink>)
            </DocDefTerm>
            <DocDefDescription>
        ...
        <DocDefDescription>
          ...
          <DocDefList>
            <DocDefTerm>
              **`status`** (list of <DocLink slug="/en/observability/synthetics-lightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
            ...
            <DocDefTerm>
              **`body.positive`** (list of <DocLink slug="/en/observability/synthetics-lightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
            ...
            <DocDefTerm>
              **`body.negative`** (list of <DocLink slug="/en/observability/synthetics-lightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
