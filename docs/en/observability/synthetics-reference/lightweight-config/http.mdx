...
<DocTable columns={[
  ...
  <DocRow>
    <DocCell>
      ...
      (<DocLink id="enObservabilitySyntheticsLightweight" section="number">number</DocLink>)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      <DocDefList>
        ...
        <DocDefTerm>
          **`include_body_max_bytes`** (<DocLink id="enObservabilitySyntheticsLightweight" section="number">number</DocLink>)
        </DocDefTerm>
        <DocDefDescription>
      ...
      <DocDefList>
        ...
        <DocDefDescription>
          ...
          <DocDefList>
            ...
            <DocDefTerm>
              **`body`** (<DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>)
            </DocDefTerm>
            <DocDefDescription>
        ...
        <DocDefDescription>
          ...
          <DocDefList>
            <DocDefTerm>
              **`status`** (list of <DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
            ...
            <DocDefTerm>
              **`body.positive`** (list of <DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
            ...
            <DocDefTerm>
              **`body.negative`** (list of <DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>s)
            </DocDefTerm>
            <DocDefDescription>
