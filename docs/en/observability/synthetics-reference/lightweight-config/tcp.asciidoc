...
// hosts
| [[monitor-tcp-hosts]] *`hosts`* (<<synthetics-lightweight-data-string,string>>)
...
proxy_url
////////////////
a| [[monitor-tcp-proxy_url]] *`proxy_url`*
...
////////////////
a| [[monitor-tcp-proxy_use_local_resolver]] *`proxy_use_local_resolver`*
