...
// hosts
| [[monitor-http-hosts]] *`hosts`* (<<synthetics-lightweight-data-string,string>>)
a| *Required*. The URL to ping.

////////////////////////
max_redirects
////////////////////////
a| [[monitor-http-max_redirects]] *`max_redirects`*
...
proxy_url
////////////////////////
a| [[monitor-http-proxy_url]] *`proxy_url`*
...
username
////////////////////////
a| [[monitor-http-username]] *`username`*
(<<synthetics-lightweight-data-string,string>>)
...
password
////////////////////////
a| [[monitor-http-password]] *`password`*
(<<synthetics-lightweight-data-string,string>>)
...
headers
////////////////////////
a| [[monitor-http-headers]] *`headers`*
...
////////////////////////
*`method`* (`"HEAD"`, `"GET"`, `"POST"`, or `"OPTIONS"`)::: The HTTP method to use.
