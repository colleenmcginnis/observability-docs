...
<DocTable columns={[
  ...
  <DocRow>
    <DocCell>
      ...
      (<DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-enabled">
        **`enabled`**
      </span>
      (<DocLink id="enObservabilitySyntheticsLightweight" section="boolean">boolean</DocLink>)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-schedule">
        **`schedule`**
      </span>
      (<DocLink id="enObservabilitySyntheticsLightweight" section="duration">duration</DocLink>)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      ...
      (list of <DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>s)
    </DocCell>
    <DocCell>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-alert">
        **`alert`**
      </span>
    </DocCell>
    <DocCell>
      Enable or disable alerts on this monitor. Read more about alerts in <DocLink id="enObservabilitySyntheticsSettings" section="alerting">Alerting</DocLink>.

      <DocDefList>
        <DocDefTerm>
          **`status.enabled`** (<DocLink id="enObservabilitySyntheticsLightweight" section="boolean">boolean</DocLink>)
        </DocDefTerm>
        <DocDefDescription>
        ...
        <DocDefTerm>
          **`tls.enabled`** (<DocLink id="enObservabilitySyntheticsLightweight" section="boolean">boolean</DocLink>)
        </DocDefTerm>
        <DocDefDescription>
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-retest_on_failure">
        **`retest_on_failure`**
      </span>
      (<DocLink id="enObservabilitySyntheticsLightweight" section="boolean">boolean</DocLink>)
    </DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      **Examples**:
      ...
      <DocLink id="enObservabilitySyntheticsConfiguration" section="monitor">`monitor.locations` in the project configuration file</DocLink>
      or via the CLI using the <DocLink id="enObservabilitySyntheticsCommandReference" section="elasticsynthetics-push">`--location` flag on `push`</DocLink>.
  ...
  <DocRow>
    <DocCell>
      <span id="monitor-private_locations">
        **`private_locations`**
      </span>
      (list of <DocLink id="enObservabilitySyntheticsLightweight" section="string">string</DocLink>s)
    </DocCell>
    <DocCell>
      The <DocLink id="enObservabilitySyntheticsPrivateLocation">((private-location))s</DocLink> to which the monitors will be deployed. These ((private-location))s refer to locations hosted and managed by you, whereas  `locations` are hosted by Elastic. You can specify a ((private-location)) using the location's name.

      To list available ((private-location))s you can:

      * Run the <DocLink id="enObservabilitySyntheticsCommandReference" section="elasticsynthetics-locations">`elastic-synthetics locations` command</DocLink> and specify the ((kib)) URL of the deployment. This will fetch all available private locations associated with the deployment.
      ...
      **Examples**:
      ...
      <DocCallOut title="Note">
      This can also be set using
      <DocLink id="enObservabilitySyntheticsConfiguration" section="monitor">`monitor.privateLocations` in the project configuration file</DocLink>
      or via the CLI using the <DocLink id="enObservabilitySyntheticsCommandReference" section="elasticsynthetics-push">`--privateLocations` flag on `push`</DocLink>.
