---
id: enObservabilitySyntheticsSettings
...
* In the ((synthetics-app)) UI when you <DocLink id="enObservabilitySyntheticsGetStartedUi">create a monitor</DocLink>.
...
* In projects when <DocLink id="enObservabilitySyntheticsLightweight">configuring a lightweight monitor</DocLink>.
...
Read more about all available connectors in <DocLink id="enObservabilityDurationAnomalyAlert" section="action-types">Action types</DocLink>.
...
After you <DocLink id="enObservabilitySyntheticsPrivateLocation" section="set-up-((fleet-server))-and-((agent))">Set up ((fleet-server)) and ((agent))</DocLink> and <DocLink id="enObservabilitySyntheticsPrivateLocation" section="connect-to-the-((stack))">Connect to the ((stack))</DocLink>,
...
To learn more about the other methods and which methods take precedence over others, see <DocLink id="enObservabilitySyntheticsParamsSecrets">Work with params and secrets</DocLink>.
...
Learn more about the data included in each data stream in <DocLink id="enObservabilitySyntheticsManageRetention">Manage data retention</DocLink>.
...
Learn more about using API keys in <DocLink id="enObservabilitySyntheticsGetStartedProject">Create monitors with ((project-monitors-cap))</DocLink>.
