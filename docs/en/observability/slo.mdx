...
* **Alerts:** active alerts if you've set any <DocLink id="enObservabilitySloBurnRateAlert">SLO burn rate alert rules</DocLink> for the SLO.
...
* <DocLink id="enObservabilitySloPrivileges">Configure SLO access</DocLink>
* <DocLink id="enObservabilitySloCreate">Create an SLO</DocLink>
* <DocLink id="enObservabilitySloBurnRateAlert">Create an SLO burn rate alert rule</DocLink>
