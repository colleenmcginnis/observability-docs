---
id: enObservabilitySyntheticsPrivateLocation
...
* <DocLink id="enObservabilitySyntheticsPrivateLocation" section="set-up-((fleet-server))-and-((agent))">Set up ((fleet-server)) and ((agent))</DocLink>.
* <DocLink id="enObservabilitySyntheticsPrivateLocation" section="connect-to-the-((stack))">Connect ((fleet)) to the ((stack))</DocLink> and enroll an ((agent)) in ((fleet)).
* <DocLink id="enObservabilitySyntheticsPrivateLocation" section="add-a-((private-location))">Add a ((private-location))</DocLink> in the ((synthetics-app)).
...
multiple ((agents)). See <DocLink id="enObservabilitySyntheticsPrivateLocation" section="scaling-((private-location))s">Scaling ((private-location))s</DocLink> for information on increasing the capacity
...
Now you can add monitors to your ((private-location)) in <DocLink id="enObservabilitySyntheticsGetStartedUi">the ((synthetics-app))</DocLink> or using the <DocLink id="enObservabilitySyntheticsGetStartedProject">Elastic Synthetics library's `push` method</DocLink>.
