...
* <<aiops-tune-anomaly-detection-job-create-calendars,Create calendars>> that contain a list of scheduled events for which you do not want to generate anomalies, such as planned system outages or public holidays.
* <<aiops-tune-anomaly-detection-job-create-job-rules-and-filters,Create job rules>> that instruct anomaly detectors to change their behavior based on domain-specific knowledge that you provide.
...
* <<aiops-tune-anomaly-detection-job-define-custom-urls,Define custom URLs>> to make dashboards and other resources readily available when viewing job results.
...
[[aiops-tune-anomaly-detection-job-create-calendars]]
...
[discrete]
[[aiops-tune-anomaly-detection-job-create-job-rules-and-filters]]
...
[[aiops-tune-anomaly-detection-job-define-custom-urls]]
