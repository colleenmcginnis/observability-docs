...
The **Transactions** table displays a list of *transaction groups* for the selected service.
...
By default, transaction groups are sorted by *Impact*.
Impact helps show the most used and slowest endpoints in your service — in other words,
it's the collective amount of pain a specific endpoint is causing your users.
If there's a particular endpoint you're worried about, you can click on it to view the <<apm-transactions-transaction-details,transaction details>>.
...
[[apm-transactions-transaction-details]]
...
[[apm-transactions-transaction-duration-distribution]]

[discrete]
[[apm-transactions-latency-distribution]]
...
[[apm-transactions-transaction-trace-sample]]

[discrete]
[[apm-transactions-trace-samples]]
=== Trace samples

Trace samples are based on the *bucket* selection in the **Latency distribution** chart;
update the samples by selecting a new *bucket*.
...
and ultimately determining *why* a request was slow.
...
[[apm-transactions-transaction-latency-correlations]]

[discrete]
[[apm-transactions-correlations]]
=== Correlations
