...
Some APM agents offer a way to manipulate or drop APM events *before* they leave your services.
...
**Filter API**: Drop APM events *before* they are sent to Elastic. Read more in the {apm-dotnet-ref-v}/public-api.html#filter-api[.NET agent Filter API docs].

[discrete]
[[apm-keep-data-secure-nodejs]]
=== Node.js

* **`addFilter()`**: Drop APM events *before* they are sent to Elastic. Read more in the {apm-node-ref-v}/agent-api.html#apm-add-filter[Node.js agent API docs].
...
**Custom processors**: Drop APM events *before* they are sent to Elastic. Read more in the {apm-py-ref-v}/sanitizing-data.html[Python agent Custom processors docs].

[discrete]
[[apm-keep-data-secure-ruby]]
=== Ruby

**`add_filter()`**: Drop APM events *before* they are sent to Elastic. Read more in the {apm-ruby-ref-v}/api.html#api-agent-add-filter[Ruby agent API docs].
