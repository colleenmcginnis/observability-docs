...
. <<create-an-slo-define-your-sli,Define your service-level indicator (SLI)>>.
. <<create-an-slo-set-your-objectives,Set your objectives>>.
. <<create-an-slo-describe-your-slo,Describe your SLO>>.

[[create-an-slo-define-sli]]

[discrete]
[[create-an-slo-define-your-sli]]
== Define your SLI

The type of SLI to use depends on the location of your data:

* <<create-an-slo-custom-kql,Custom KQL>>: Create an SLI based on raw logs coming from your services.
* <<create-an-slo-timeslice-metric,Timeslice metric>>: Create an SLI based on a custom equation that uses multiple aggregations.
* <<create-an-slo-custom-metric,Custom metric>>: Create an SLI to define custom equations from metric fields in your indices.
* <<create-an-slo-histogram-metric,Histogram metric>>: Create an SLI based on histogram metrics.
* <<create-an-slo-apm-latency-and-apm-availability,APM latency and APM availability>>: Create an SLI based on services using application performance monitoring (APM).

[[create-an-slo-custom-kql]]
...
[[create-an-slo-timeslice-metric]]
...
[[create-an-slo-histogram-metric]]
...
[[create-an-slo-apm-latency-and-availability]]

[discrete]
[[create-an-slo-apm-latency-and-apm-availability]]
...
[[create-an-slo-synthetics-availability-sli]]

[discrete]
[[create-an-slo-synthetics-availability]]
...
* **Monitor name** — The name of one or more <<monitor-name,synthetic monitors>>.
* **Project** — The ID of one or more <<synthetics-configuration-project,projects>> containing synthetic monitors.
* **Tags** — One or more <<monitor-tags,tags>> assigned to synthetic monitors.
...
[[create-an-slo-set-slo]]

[discrete]
[[create-an-slo-set-your-objectives]]
== Set your objectives

After defining your SLI, you need to set your objectives. To set your objectives, complete the following:

. <<create-an-slo-select-your-budgeting-method,Select your budgeting method>>
. <<create-an-slo-set-your-time-window-and-duration,Set your time window>>
. <<create-an-slo-set-your-targetslo-percent,Set your target/SLO percentage>>

[[create-an-slo-slo-time-window]]

[discrete]
[[create-an-slo-set-your-time-window-and-duration]]
...
[[create-an-slo-slo-budgeting-method]]

[discrete]
[[create-an-slo-select-your-budgeting-method]]
...
[[create-an-slo-slo-target]]

[discrete]
[[create-an-slo-set-your-targetslo-percent]]
=== Set your target/SLO (%)

The SLO target objective as a percentage.

[[create-an-slo-slo-describe]]

[discrete]
[[create-an-slo-describe-your-slo]]
== Describe your SLO

After setting your objectives, give your SLO a name, a short description, and add any relevant tags.

[[create-an-slo-slo-alert-checkbox]]

[discrete]
[[create-an-slo-slo-burn-rate-alert-rule]]
