...
[[ecs-application-logs-ecs-logging-logs]]
...
* <<ecs-application-logs-apm-agent-ecs-reformatting,**{apm-agent} ECS reformatting:**>> Java, Ruby, and Python {apm-agent}s automatically reformat application logs to ECS format without a logger.
...
[[ecs-application-logs-reformatting-logs]]

[discrete]
[[ecs-application-logs-apm-agent-ecs-reformatting]]
