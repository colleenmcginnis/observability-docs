...
* <<filter-and-aggregate-logs-filter-logs,Filter logs>>: Narrow down your log data by applying specific criteria.
* <<filter-and-aggregate-logs-aggregate-logs,Aggregate logs>>: Analyze and summarize data to find patterns and gain insight.

[[filter-and-aggregate-logs-logs-filter-and-aggregate-prereq]]

[discrete]
[[filter-and-aggregate-logs-before-you-get-started]]
...
[[filter-and-aggregate-logs-logs-filter]]

[discrete]
[[filter-and-aggregate-logs-filter-logs]]
== Filter logs
...
* <<filter-and-aggregate-logs-filter-logs-in-logs-explorer,Filter logs in Logs Explorer>>: Filter and visualize log data in Logs Explorer.
* <<filter-and-aggregate-logs-filter-logs-with-query-dsl,Filter logs with Query DSL>>: Filter log data from Developer Tools using Query DSL.

[[filter-and-aggregate-logs-logs-filter-logs-explorer]]

[discrete]
[[filter-and-aggregate-logs-filter-logs-in-logs-explorer]]
...
[[filter-and-aggregate-logs-logs-filter-qdsl]]

[discrete]
[[filter-and-aggregate-logs-filter-logs-with-query-dsl]]
...
[[filter-and-aggregate-logs-logs-aggregate]]

[discrete]
[[filter-and-aggregate-logs-aggregate-logs]]
== Aggregate logs
