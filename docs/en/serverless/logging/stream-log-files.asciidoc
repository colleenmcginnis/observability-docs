...
To install and configure the {agent} manually, refer to <<stream-log-files-manually-install-and-configure-the-standalone-agent,Manually install and configure the standalone {agent}>>.
...
[discrete]
[[stream-log-files-manually-install-and-configure-the-standalone-agent]]
...
[[stream-log-files-api-key-beats]]
...
----
. You *must* set the API key to configure {beats}.
