...
[[synthetics-settings-synthetics-settings-alerting]]
...
. Click **Alerts and rules** in the top bar.
. Click **Manage rules** to go to the *Rules* page.

On the *Rules* page, you can manage the default synthetics rules including snoozing rules,
...
* In the UI *after* a monitor is already created, on the **Monitors** page
...
// Read more about all available connectors in <<create-anomaly-alert-rule-action-types,Action types>>.

[role="screenshot"]
image::images/synthetics-settings-alerting.png[Alerting tab on the Synthetics Settings page in an Observability project]

[[synthetics-settings-synthetics-settings-private-locations]]
...
After you <<synthetics-private-location-set-up-agent,Set up {agent}>> and <<synthetics-private-location-connect-to-your-observability-project,Connect to your Observability project>>,
...
[[synthetics-settings-synthetics-settings-global-parameters]]
...
[[synthetics-settings-synthetics-settings-data-retention]]
...
[[synthetics-settings-synthetics-settings-api-keys]]

[discrete]
[[synthetics-settings-project-api-keys]]
== Project API keys
