...
Lightweight monitors can be configured using either the <<synthetics-lightweight-synthetics-ui,Synthetics UI>>
or a <<synthetics-lightweight-synthetics-project,Synthetics project>>.

[[synthetics-lightweight-synthetics-lightweight-ui]]

[discrete]
[[synthetics-lightweight-synthetics-ui]]
== Synthetics UI
...
[[synthetics-lightweight-synthetics-monitor-options]]
...
* <<synthetics-lightweight-http-options,HTTP options>>
* <<synthetics-lightweight-icmp-options,ICMP options>>
* <<synthetics-lightweight-tcp-options,TCP options>>

The `tcp` and `http` monitor types both support SSL/TLS and some proxy settings.

[[synthetics-lightweight-synthetics-lightweight-common-options]]
...
[[synthetics-lightweight-synthetics-lightweight-http]]

[discrete]
[[synthetics-lightweight-http-options]]
=== HTTP options
...
[[synthetics-lightweight-synthetics-lightweight-icmp]]

[discrete]
[[synthetics-lightweight-icmp-options]]
=== ICMP options
...
[[synthetics-lightweight-synthetics-lightweight-tcp]]

[discrete]
[[synthetics-lightweight-tcp-options]]
=== TCP options
...
[[synthetics-lightweight-synthetics-lightweight-data-types]]

[discrete]
[[synthetics-lightweight-data-types-reference]]
...
[[synthetics-lightweight-synthetics-lightweight-data-bool]]

[discrete]
[[synthetics-lightweight-boolean]]
==== Boolean
...
[[synthetics-lightweight-synthetics-lightweight-data-numbers]]

[discrete]
[[synthetics-lightweight-number]]
==== Number

Number values require you to enter the number *without* single or
double quotes.
...
[[synthetics-lightweight-synthetics-lightweight-data-string]]

[discrete]
[[synthetics-lightweight-string]]
==== String
...
[[synthetics-lightweight-synthetics-lightweight-data-duration]]

[discrete]
[[synthetics-lightweight-duration]]
==== Duration
...
[[synthetics-lightweight-synthetics-lightweight-data-regex]]

[discrete]
[[synthetics-lightweight-regular-expression]]
==== Regular expression
