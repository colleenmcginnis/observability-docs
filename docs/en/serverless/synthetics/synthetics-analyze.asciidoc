...
[[synthetics-analyze-synthetics-analyze-overview]]
...
[[synthetics-analyze-synthetics-analyze-individual-monitors]]

[discrete]
[[synthetics-analyze-all-monitor-types]]
== All monitor types
...
The *Duration trends* chart displays the timing for each check that was performed in the last 30 days.
...
[[synthetics-analyze-synthetics-analyze-individual-monitors-history]]

[discrete]
[[synthetics-analyze-history]]
=== History
...
included the in <<synthetics-analyze-details-for-one-run,Details for one run>> section below.
...
[[synthetics-analyze-synthetics-analyze-individual-monitors-errors]]

[discrete]
[[synthetics-analyze-errors]]
=== Errors
...
that is included the in <<synthetics-analyze-details-for-one-run,Details for one run>> section below.
...
[[synthetics-analyze-synthetics-analyze-journeys]]

[discrete]
[[synthetics-analyze-browser-monitors]]
== Browser monitors
...
[[synthetics-analyze-journey_runs_over_time]]

[discrete]
[[synthetics-analyze-journey-runs-over-time]]
...
* A list of the **last 10 test runs** that link to the <<synthetics-analyze-details-for-one-run,details for each run>>.
...
This will take you to the view described below in <<synthetics-analyze-details-for-one-run,Details for one run>>.
...
This will take you to the view described below in <<synthetics-analyze-details-for-one-step,Details for one step>>.

[[synthetics-analyze-synthetics-analyze-one-run]]

[discrete]
[[synthetics-analyze-details-for-one-run]]
=== Details for one run
...
At the top of the page, see the *Code executed* and any *Console* output for each step.
If the step failed, this will also include a *Stacktrace* tab that you can use to
...
Read more about step-level metrics below in <<synthetics-analyze-timing,Timing>> and
<<synthetics-analyze-metrics,Metrics>>.
...
[[synthetics-analyze-synthetics-analyze-one-step]]

[discrete]
[[synthetics-analyze-details-for-one-step]]
...
[[synthetics-analyze-synthetics-analyze-one-step-screenshot]]

[discrete]
[[synthetics-analyze-screenshot]]
==== Screenshot
...
the <<synthetics-command-reference-elasticsynthetics,CLI>>.
====
...
[[synthetics-analyze-synthetics-analyze-one-step-timing]]

[discrete]
[[synthetics-analyze-timing]]
==== Timing
...
signal to look at more granular information in the <<synthetics-analyze-network-requests,Network requests>> section.
...
[[synthetics-analyze-synthetics-analyze-one-step-metrics]]

[discrete]
[[synthetics-analyze-metrics]]
==== Metrics
...
[[synthetics-analyze-synthetics-analyze-one-step-object]]

[discrete]
[[synthetics-analyze-object-weight-and-count]]
...
[[synthetics-analyze-synthetics-analyze-one-step-network]]

[discrete]
[[synthetics-analyze-network-requests]]
==== Network requests
...
(as defined in the <<synthetics-analyze-timing,Timing>> section above) and
