...
[[synthetics-configuration-synthetics-config-file]]
...
*not* the environment where monitors will run. In other words, `env`
...
the tests based on environments, look at the <<synthetics-params-secrets-synthetics-project-config-file,dynamic configuration>> documentation.

[[synthetics-configuration-synthetics-configuration-params]]
...
[[synthetics-configuration-synthetics-configuration-playwright-options]]

[discrete]
[[synthetics-configuration-playwrightoptions]]
== `playwrightOptions`
...
[[synthetics-configuration-synthetics-configuration-playwright-options-client-certificates]]

[discrete]
[[synthetics-configuration-tls-client-authentication]]
...
[[synthetics-configuration-synthetics-configuration-playwright-options-timeouts]]

[discrete]
[[synthetics-configuration-timeouts]]
=== Timeouts
...
[[synthetics-configuration-synthetics-configuration-playwright-options-timezones]]

[discrete]
[[synthetics-configuration-timezones-and-locales]]
...
To use a timezone and/or locale for a *specific* monitor, add these options to a
journey using <<synthetics-monitor-use,`monitor.use`>>.

[[synthetics-configuration-synthetics-config-device-emulation]]

[discrete]
[[synthetics-configuration-device-emulation]]
=== Device emulation
...
[[synthetics-configuration-synthetics-configuration-project]]
...
+
If you used <<synthetics-command-reference-elasticsynthetics-init,`init` to create a Synthetics project>>, this is the `<name-of-synthetics-project>` you specified.

`url` (`string`)::
The URL for the Observability project to which you want to upload the monitors.

[[synthetics-configuration-synthetics-configuration-monitor]]

[discrete]
[[synthetics-configuration-monitor]]
== `monitor`

Default values to be applied to *all* monitors when using the <<synthetics-command-reference-elasticsynthetics-push,`@elastic/synthetics` `push` command>>.
