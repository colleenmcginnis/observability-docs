...
[[synthetics-private-location-monitor-via-access-control]]

[discrete]
[[synthetics-private-location-allow-access-to-your-private-network]]
...
[[synthetics-private-location-monitor-via-private-agent]]

[discrete]
[[synthetics-private-location-monitor-via-a-private-agent]]
...
[[synthetics-private-location-synthetics-private-location-fleet-agent]]

[discrete]
[[synthetics-private-location-set-up-agent]]
== Set up {agent}
...
Do *not* run the same agent policy on multiple agents being used for {private-location}s, as you may
end up with duplicate or missing tests. {private-location}s do not currently load balance tests across
multiple {agents}. See <<synthetics-private-location-scaling-private-locations,Scaling {private-location}s>> for information on increasing the capacity
...
[[synthetics-private-location-synthetics-private-location-connect]]

[discrete]
[[synthetics-private-location-connect-to-your-observability-project]]
...
[[synthetics-private-location-synthetics-private-location-docker]]

Elastic provides Docker images that you can use to run {fleet} and an {agent} more easily.
For monitors running on {private-location}s, you *must* use the `elastic-agent-complete`
...
[[synthetics-private-location-synthetics-private-location-add]]

[discrete]
[[synthetics-private-location-add-a-private-location]]
...
[[synthetics-private-location-synthetics-private-location-scaling]]

[discrete]
[[synthetics-private-location-scaling-private-locations]]
...
[[synthetics-private-location-synthetics-private-location-next]]

[discrete]
[[synthetics-private-location-next-steps]]
== Next steps
