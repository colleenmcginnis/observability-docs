...
[[synthetics-get-started-ui-private-locations]]
...
<<synthetics-troubleshooting-no-locations-are-available,troubleshooting guide>> for guidance.
====
+
[NOTE]
====
If you've <<synthetics-private-location,added a {private-location}>>,
you'll see your the {private-location} in the list of *Locations*.
...
Each browser monitor configured using an inline script can contain only *one* journey,
...
For more information, refer to <<synthetics-analyze-browser-monitors,Analyze data from synthetic monitors>>.
