...
[[synthetics-command-reference-elastic-synthetics-command]]

[discrete]
[[synthetics-command-reference-elasticsynthetics]]
== `@elastic/synthetics`
...
<<synthetics-configuration-playwrightoptions,the configuration docs>>.
+
Options passed will be merged with Playwright options defined in your
<<synthetics-configuration-playwrightoptions,`synthetics.config.js` file>>.
...
run synthetic tests locally or push them to Elastic. Filtering is *not* supported in any other subcommands
...
[[synthetics-command-reference-elastic-synthetics-init-command]]

[discrete]
[[synthetics-command-reference-elasticsynthetics-init]]
...
[[synthetics-command-reference-elastic-synthetics-push-command]]

[discrete]
[[synthetics-command-reference-elasticsynthetics-push]]
...
+
To list available locations, refer to <<synthetics-command-reference-elasticsynthetics-locations,`@elastic/synthetics locations`>>.
+
This can also be set in the configuration file using
...
+
To list available {private-location}s, refer to <<synthetics-command-reference-elasticsynthetics-locations,`@elastic/synthetics locations`>>.
+
This can also be set in the configuration file using
...
and those labels are displayed in {kib} in the *Monitor details* panel in the <<synthetics-analyze-overview-1,individual monitor's *Overview* tab>>.
+
...
it using a *different* ID, it will create duplicates of all monitors in the Synthetics project.
...
[[synthetics-command-reference-elastic-synthetics-locations-command]]

[discrete]
[[synthetics-command-reference-elasticsynthetics-locations]]
