...
* Each host name is an active link to a <<analyze-hosts-view-host-details,host details>> page,
...
[[analyze-hosts-analyze-hosts-filter-view]]

[discrete]
[[analyze-hosts-filter-the-hosts-view]]
...
[TIP]
====
Filtered results are sorted by *document count*.
...
[[analyze-hosts-analyze-hosts-inspect-data]]

[discrete]
[[analyze-hosts-view-metrics]]
== View metrics
...
To see metrics for a specific host, refer to <<analyze-hosts-view-host-details,View host details>>.
...
[[analyze-hosts-analyze-hosts-open-in-lens]]
...
[[analyze-hosts-analyze-hosts-view-logs]]
...
To see logs for a specific host, refer to <<analyze-hosts-view-host-details,View host details>>.

[[analyze-hosts-analyze-hosts-view-alerts]]
...
To see alerts for a specific host, refer to <<analyze-hosts-view-host-details,View host details>>.
...
[[analyze-hosts-view-host-details]]
...
[[analyze-hosts-analyze-hosts-why-dashed-lines]]

[discrete]
[[analyze-hosts-why-am-i-seeing-dashed-lines-in-charts]]
== Why am I seeing dashed lines in charts?

There are a few reasons why you may see dashed lines in your charts.

* <<analyze-hosts-the-chart-interval-is-too-short,The chart interval is too short>>
* <<analyze-hosts-data-is-missing,Data is missing>>
* <<analyze-hosts-the-chart-interval-is-too-short-and-data-is-missing,The chart interval is too short and data is missing>>

[[analyze-hosts-dashed-interval]]

[discrete]
[[analyze-hosts-the-chart-interval-is-too-short]]
...
[[analyze-hosts-dashed-missing]]

[discrete]
[[analyze-hosts-data-is-missing]]
=== Data is missing
...
=== What does *this host has been detected by APM* mean?
