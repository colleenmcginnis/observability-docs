...
* <<host-metrics-hosts-metrics,Hosts>>
* <<host-metrics-cpu-usage-metrics,CPU usage>>
* <<host-metrics-memory-metrics,Memory>>
* <<host-metrics-log-metrics,Log>>
* <<host-metrics-network-metrics,Network>>
* <<host-metrics-network-metrics,Disk>>
* <<host-metrics-legacy-metrics,Legacy>>

[[host-metrics-key-metrics-hosts]]

[discrete]
[[host-metrics-hosts-metrics]]
== Hosts metrics
...
[[host-metrics-key-metrics-cpu]]

[discrete]
[[host-metrics-cpu-usage-metrics]]
== CPU usage metrics
...
For legacy metric calculations, refer to <<host-metrics-legacy-metrics,Legacy metrics>>.
...
[[host-metrics-key-metrics-memory]]

[discrete]
[[host-metrics-memory-metrics]]
== Memory metrics
...
[[host-metrics-key-metrics-log]]

[discrete]
[[host-metrics-log-metrics]]
== Log metrics
...
[[host-metrics-key-metrics-network]]

[discrete]
[[host-metrics-network-metrics]]
== Network metrics
