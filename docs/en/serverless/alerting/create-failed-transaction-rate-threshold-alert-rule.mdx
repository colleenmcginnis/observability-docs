...
[[create-failed-transaction-rate-threshold-alert-rule-create-failed-transaction-rate-threshold-example]]

[discrete]
[[create-failed-transaction-rate-threshold-alert-rule-example]]
== Example
