...
[[create-custom-threshold-alert-rule-custom-threshold-scope]]

[discrete]
[[create-custom-threshold-alert-rule-define-rule-data]]
== Define rule data

Specify the following settings to define the data the rule applies to:

* **Select a data view:** Click the data view field to search for and select a data view that points to the indices or data streams that you're creating a rule for. You can also create a *new* data view by clicking **Create a data view**. Refer to {kibana-ref}/data-views.html[Create a data view] for more on creating data views.
...
[[create-custom-threshold-alert-rule-custom-threshold-rule-conditions]]

[discrete]
[[create-custom-threshold-alert-rule-set-rule-conditions]]
== Set rule conditions

Set the conditions for the rule to detect using aggregations, an equation, and a threshold.

[[create-custom-threshold-alert-rule-custom-threshold-aggregation]]

[discrete]
[[create-custom-threshold-alert-rule-set-aggregations]]
=== Set aggregations
...
[[create-custom-threshold-alert-rule-custom-threshold-equation]]

[discrete]
[[create-custom-threshold-alert-rule-set-the-equation-and-threshold]]
...
[[create-custom-threshold-alert-rule-custom-threshold-math-equation]]

[discrete]
[[create-custom-threshold-alert-rule-basic-math-equation]]
=== Basic math equation
...
[[create-custom-threshold-alert-rule-custom-threshold-boolean-equation]]

[discrete]
[[create-custom-threshold-alert-rule-boolean-logic]]
=== Boolean logic
...
[[create-custom-threshold-alert-rule-custom-threshold-chart-preview]]

[discrete]
[[create-custom-threshold-alert-rule-preview-chart]]
== Preview chart
...
[[create-custom-threshold-alert-rule-custom-threshold-group-by]]

[discrete]
[[create-custom-threshold-alert-rule-group-alerts-by-optional]]
