...
preview:[]  To temporarily suppress notifications for *all* rules, create a https://www.elastic.co/docs/current/serverless/maintenance-windows[maintenance window].
