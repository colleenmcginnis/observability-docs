...
The **Transactions** table displays a list of *transaction groups* for the
...
By default, transaction groups are sorted by *Impact* to show the most used and slowest endpoints in your
