...
* To update the configuration of *all* monitors in a Synthetics project, edit the
...
<<synthetics-create-test-test-locally,test the updated journey locally>> to make sure it's valid.

After making changes to the monitors, run the <<synthetics-command-reference-elasticsynthetics-push,`push` command>>
